...
@section('content')
   <div class="col-md-5 p-5 bg-white full-height authLeftSection">
      <div class="login-main-left">
         ...
         @endif
         <form action="{{ route('statictics.login.post') }}" method="post">
         @csrf
         ...
         <div class="text-center mt-2">
            <p class="light-gray auth_P" style="font-size:13px;">Don’t have an account? <a href="{{ route('member.register') }}">Sign Up</a></p>
         </div>
