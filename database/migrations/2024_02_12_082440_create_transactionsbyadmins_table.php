...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactionsbyadmins', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('transaction_table_id')->unsigned()->nullable()->comment("['id of the transactions table']");
            ...
            $table->string('transaction_type','20')->nullable()->comment("['wire_transfer', 'paypal', 'rv_coins', 'assign_by_admin']");
    ...
    {
        Schema::dropIfExists('transactionsbyadmins');
    }
};
