...
(function () {
    ...
    var xa = function (a, b, c) {
        ...
        Fa = function (a) {
            ...
            this.throw = function (b) {
                va(a.g);
                a.g.o ? b = Ba(a, a.g.o["throw"], b, a.g.B) : (wa(a.g, b), b = Ca(a));
                return b
            };
    ...
    p("Promise", function (a) {
        ...
        e.race = function (g) {
            return new e(function (h, k) {
                for (var m = t(g), n = m.next(); !n.done; n = m.next()) c(n.value).jc(h, k)
            })
        };
        e.all = function (g) {
            var h = t(g),
            ...
            return k.done ? c([]) : new e(function (m, n) {
                ...
                var r = [],
                    v = 0;
                do r.push(void 0), v++, c(k.value).jc(q(r.length -
    ...
    p("Map", function (a) {
        ...
        c.prototype.set = function (h, k) {
            ...
            m.na ? m.na.value = k : (m.na = {
                ...
                key: h,
                value: k
            }, m.list.push(m.na), this[1].Ua.next = m.na, this[1].Ua = m.na, this.size++);
            return this
        };
        c.prototype.delete = function (h) {
            h = d(this, h);
            return h.na && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], h.na.Ua.next = h.na.next, h.na.next.Ua =
                h.na.Ua, h.na.head = null, this.size--, !0) : !1
        };
    ...
    */
    var La = La || {},
        ...
        Za = function (a, b, c) {
            Za = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? Wa : Ya;
    ...
    var eb;
    var fb, gb = "function" === typeof String.prototype.g,
    ...
    function jb(a) {
        ...
        b = void 0 === b ? !1 : b;
        if (ib) {
            if (b && (gb ? !a.g() : /(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])/.test(a))) throw Error("Found an unpaired surrogate");
    ...
    function Fb() {
        return z("Safari") && !(Gb() || (zb() ? 0 : z("Coast")) || Ab() || (zb() ? 0 : z("Edge")) || (zb() ? yb("Microsoft Edge") : z("Edg/")) || (zb() ? yb("Opera") : z("OPR")) || Eb() || z("Silk") || z("Android"))
    }

    function Gb() {
        return zb() ? yb("Chromium") : (z("Chrome") || z("CriOS")) && !(zb() ? 0 : z("Edge")) || z("Silk")
    };
    ...
    var ic = Ab(),
        jc = Bb(),
        kc = z("Edge"),
        lc = z("Gecko") && !(qb(vb(), "WebKit") && !z("Edge")) && !(z("Trident") || z("MSIE")) && !z("Edge"),
    ...
    function Zc(a) {
        ...
        b && (c = t($c(c, a)), b = c.next().value, a = c.next().value, c = b);
        Wc = c >>> 0;
        Xc = a >>> 0
    }
    ...
    function ad(a, b) {
        ...
        else Tc() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215, b = b >> 16 & 65535, a = (a & 16777215) + 6777216 * c + 6710656 * b, c += 8147497 * b, b *= 2, 1E7 <= a && (c += Math.floor(a / 1E7), a %= 1E7), 1E7 <= c && (b += Math.floor(c / 1E7), c %= 1E7), c = b + bd(c) + bd(a));
        return c
    }
    ...
    function cd() {
        var a = Wc,
            b = Xc;
        b & 2147483648 ? Tc() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = t($c(a, b)), a = b.next().value, b = b.next().value, a = "-" + ad(a, b)) : a = ad(a, b);
        return a
    }

    function dd(a) {
        if (16 > a.length) Zc(Number(a));
        else if (Tc()) a = BigInt(a), Wc = Number(a & BigInt(4294967295)) >>> 0, Xc = Number(a >> BigInt(32) & BigInt(4294967295));
        else {
            var b = +("-" === a[0]);
            Xc = Wc = 0;
            for (var c = a.length, d = 0 + b, e = (c - b) % 6 + b; e <= c; d = e, e += 6) d = Number(a.slice(d, e)), Xc *= 1E6, Wc = 1E6 * Wc + d, 4294967296 <= Wc && (Xc += Math.trunc(Wc / 4294967296), Xc >>>= 0, Wc >>>= 0);
            b && (b = t($c(Wc, Xc)), a = b.next().value, b = b.next().value, Wc = a, Xc = b)
        }
    }
    ...
    var wd;
    wd = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol() : void 0;
    var xd = wd ? function (a, b) {
        a[wd] |= b
    } : function (a, b) {
    ...
    function Zd(a) {
        if ("boolean" !== typeof a) throw Error("Expected boolean but got " + Oa(a) + ": " + a);
        return a
    }
    ...
    function be(a) {
        var b = typeof a;
        return "number" === b ? Number.isFinite(a) : "string" !== b ? !1 : ae.test(a)
    }
    ...
    function je(a) {
        if (null != a) {
            ...
            "string" === typeof a ? a = ke(a) : b ? (a = Math.trunc(a), Number.isSafeInteger(a) ? a = String(a) : (b = String(a), le(b) ? a = b : (Zc(a), a = cd()))) : a = me(a)
        }
        return a
    }
    ...
    function xe(a) {
        switch (typeof a) {
            ...
            case "number":
                return 0 < a ? void 0 : 0 === a ? we || (we = [0, void 0]) : [-a, void 0];
            case "string":
                return [0, a];
            case "object":
                return a
    ...
    function Be(a, b, c, d, e, f) {
        if (null != a) {
            if (Array.isArray(a)) a = e && 0 == a.length && zd(a) & 1 ? void 0 : f && zd(a) & 2 ? a : Ce(a, b, c, void 0 !== d, e, f);
            else if (Qd(a)) {
                var g = {},
                    h;
    ...
    function Fe(a, b, c) {
        ...
        if (null != a) {
            ...
            if (Array.isArray(a)) {
                ...
                return b ? (Ad(a, (d | 34) & -12293), a) : Ce(a, Fe, d & 4 ? Gd : c, !0, !1, !0)
            }
            a.pd === Jd && (c = a.M, d = Dd(c), a = d & 2 ? a : ue(a.constructor, Ge(c, d, !0)));
            return a
        }
    }
    ...
    function Me(a, b, c) {
        ...
        var d = Dd(a),
            ...
            g = zd(f);
        if (!(4 & g)) {
            if (4 & g || Object.isFrozen(f)) f = vd(f), g = Oe(g, d, !1), d = Ke(a, d, b, f);
        ...
        Qe(g) || (c = g, (h = 1 === e) ? g = Cd(g, 2, !0) : g = Cd(g, 32, !1), g !== c && Ad(f, g), h && Object.freeze(f));
        2 === e && Qe(g) && (f = vd(f), g = Oe(g, d, !1), Ad(f, g), Ke(a, d, b, f));
        return f
    }
    ...
    function Re(a, b, c, d) {
        ...
        var g = zd(c),
            ...
            m = !k && !1;
        if (!(4 & g))
            for (g = 21, k && (c = vd(c), h = 0, g = Oe(g, f, !0)), k = 0; k < c.length; k++) c[k] = d(c[k]);
    ...
    function We(a, b, c, d, e, f) {
        ...
        if (f && !c) {
            ...
            f = g;
            c = m;
            for (q = 0; q < f.length; q++) m =
                f[q], r = He(m), m !== r && (f[q] = r);
            c = Cd(c, 8, !0);
            c = Cd(c, 16, !f.length);
            Ad(f, c);
            m = c
        }
        Qe(m) || (f = m, k ? m = Cd(m, !g.length || 16 & m && (!n || 32 & m) ? 2 : 2048, !0) : e || (m = Cd(m, 32, !1)), m !== f && Ad(g, m), k && Object.freeze(g));
    ...
    var Xe = function (a, b, c) {
        ...
        Ze = function (a, b, c) {
            ...
            for (var f = zd(c), g = f, h = !!(2 & f) || !!(2048 & f), k = h || Object.isFrozen(c), m = !0, n = !0, q = 0; q < c.length; q++) {
                var r = c[q];
    ...
    var af = function (a, b) {
            a = Je(a, b);
            var c;
            null == a ? c = a : be(a) ? "number" === typeof a ? c = me(a) : c = ke(a) : c = void 0;
            return c
        },
        bf = function (a, b) {
            return re(Je(a, b))
    ...
    function nf(a, b, c) {
        ...
        if (d && Sd) {
            ...
            for (var k, m, n = 0; n < d.length; n++)
                ...
                } else k || (q = void 0, f.length && Qd(q = f[f.length - 1]) ? k = q : f.push(k = {})), q = k[m], null == k[m] ? k[m] = c ? Ud : Ed() : c && q !== Ud && yd(q)
        }
        k = b.length;
        if (!k) return b;
        var r;
        if (Qd(f =
            ...
            a: {
                ...
                for (var x in v) {
                    ...
                    if (Array.isArray(h)) {
                        n = h;
                        if (!Vc && Td(h, d, +x) || !Uc && Ld(h) && 0 === h.size) h = null;
                        h != n && (a = !0)
                    }
                    null != h ? c[x] = h : a = !0
                }
        ...
        for (e = Id(e); 0 < k; k--) {
            x = k - 1;
            f = b[x];
            if (!(null == f || !Vc && Td(f, d, x - e) || !Uc && Ld(f) && 0 === f.size)) break;
            var S = !0
        }
        if (!r && !S) return b;
        var la;
    ...
    function sf(a) {
        ...
        var f = 0,
            g = a[++f];
        g && g.constructor === Object && (b.xf = g, g = a[++f], "function" === typeof g && (b.j = g, b.h = a[++f], g = a[++f]));
    ...
    function tf(a, b, c) {
        for (var d = Dd(a), e = Id(d), f = a.length, g = f + (d & 256 ? -1 : 0), h = d & 512 ? 1 : 0; h < g; h++) {
            var k = a[h];
            if (null != k) {
                var m = h - e,
                    n = zf(c, m);
        ...
        if (d & 256) {
            a = a[f - 1];
            for (var q in a) d = +q, Number.isNaN(d) || (e = a[q], null != e && (f = zf(c, d)) && f(b, e, d))
        }
    }
    ...
    function Cf(a, b, c) {
        a: if (null != b) {
            ...
            b = void 0
        }null != b && ("string" === typeof b && jd(b), null != b && (sd(a, c, 0), "number" === typeof b ? (a = a.g, Zc(b), ld(a, Wc, Xc)) : (c = jd(b), ld(a.g, c.h, c.g))))
    }
    ...
    var Ff = Bf(function (a, b, c) {
            b = Yd(b);
            null != b && (sd(a, c, 1), a = a.g, c = Yc || (Yc = new DataView(new ArrayBuffer(8))), c.setFloat64(0, +b, !0), Wc = c.getUint32(0, !0), Xc = c.getUint32(4, !0), pd(a, Wc), pd(a, Xc))
        }),
        Gf = Bf(function (a, b, c) {
            b = Yd(b);
            null != b && (sd(a, c, 5), a = a.g, c = Yc || (Yc = new DataView(new ArrayBuffer(8))), c.setFloat32(0, +b, !0), Xc = 0, Wc = c.getUint32(0, !0), pd(a, Wc))
        }),
        Hf = Bf(Cf),
        If = Bf(Cf),
            ...
            a: if (null != b) {
                if (be(b)) {
                    if ("string" === typeof b) {
                        ...
                        Number.isSafeInteger(d) && 0 <= d ? b = String(d) :
                            (d = b.indexOf("."), -1 !== d && (b = b.substring(0, d)), ne(b) || (dd(b), b = ad(Wc, Xc)));
                        break a
                    }
                    if ("number" === typeof b) {
                        b = Math.trunc(b);
                ...
                b = void 0
            }null != b && ("string" === typeof b && gd(b), null != b && (sd(a, c, 0), "number" === typeof b ? (a = a.g, Zc(b), ld(a, Wc, Xc)) : (c = gd(b), ld(a.g, c.h, c.g))))
        }),
        Kf = Bf(Df),
        Lf = Bf(Df),
    ...
    Of = new ud(function (a, b, c) {
        ...
        if (null != b)
            for (d = 0; d < b.length; d++) e = a, f = c, g = b[d], null != g && td(e, f, jb(g))
    }, !1);
    var Af = new ud(Ef, !0),
        xf = new ud(Ef, !0),
        Pf;
    ...
    var Pg = function (a) {
        ...
        Rg = String.prototype.repeat ? function (a, b) {
            return a.repeat(b)
        } : function (a, b) {
    ...
    var $g = function (a) {
        ...
        ch = function (a, b) {
            kg(b, function (c, d) {
                "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : bh.hasOwnProperty(d) ? a.setAttribute(bh[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c
            })
        },
        bh = {
        ...
        fh = function (a) {
            var b = a.scrollingElement ? a.scrollingElement : !mc && dh(a) ? a.documentElement : a.body || a.documentElement;
            a = a.parentWindow || a.defaultView;
            return jc && a.pageYOffset != b.scrollTop ? new Og(b.scrollLeft, b.scrollTop) : new Og(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
        },
        E = function (a) {
            return a ?
        ...
        ih = function (a, b, c) {
            var d = arguments,
                ...
                f = d[1],
                g = gh(e, String(d[0]));
            f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : ch(g, f));
    ...
    l.contains = lh;
    var th = function () {
            return tb && wb ? wb.mobile : !oh() && (z("iPod") || z("iPhone") || z("Android") || z("IEMobile"))
        },
        oh = function () {
            return tb && wb ? !wb.mobile && (z("iPad") || z("Android") || z("Silk")) : z("iPad") || z("Android") && !z("Mobile") || z("Silk")
        };
    var uh = RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"),
        vh = function (a) {
            var b = a.match(uh);
            a = b[1];
            var c = b[3];
    ...
    */
    ...
    function Dh(a) {
        if ("undefined" !== typeof MediaSource && a instanceof MediaSource) return new Fg(URL.createObjectURL(a), Gg);
    ...
    function Gh(a, b) {
        a.src = b instanceof Cg && b.constructor === Cg ? b.g : "type_error:TrustedResourceUrl";
        var c, d;
    ...
    var Rh = function () {
        ...
        Vh = function (a) {
            for (var b = a; a && a != a.parent;) a = a.parent, Ih(a) && (b =
                a);
            return b
        };
    var Wh = RegExp("^https?://(\\w|-)+\\.cdn\\.ampproject\\.(net|org)(\\?|/|$)"),
        Yh = function () {
            ...
            3 != this.h && (a = w.top.document, this.j = a.referrer, Date.parse(a.lastModified));
            Xh(this.g)
        },
        ai = function (a) {
            a = a || Xh();
            for (var b = new Zh(w.location.href, !1), c = null, d = a.length - 1, e = d; 0 <= e; --e) {
                var f = a[e];
                !c && Wh.test(f.url) && (c = f);
                if (f.url && !f.md) {
                    b = f;
        ...
        Xh = function (a) {
            ...
            if (e.location && e.location.ancestorOrigins && e.location.ancestorOrigins.length == c.length - 1)
                for (a = 1; a < c.length; ++a) b = c[a], b.url || (b.url = e.location.ancestorOrigins[a - 1] || "", b.md = !0);
            return c
        },
        bi = function () {
            var a = ai();
    ...
    function gi() {
        var a = void 0 === a ? w : a;
        var b = Math.min(fi("domLoading", a) || Infinity, fi("domInteractive", a) || Infinity);
        return Infinity === b ? Math.max(fi("responseEnd", a), fi("navigationStart", a)) : b
    };
    ...
    var ii = w.performance,
        ...
        li = function (a, b) {
            ...
            this.j = ki() || (null != c ? c : Math.random() <
                a)
        };
    li.prototype.B = function () {
        this.j = !1;
        this.A != this.g.google_js_reporting_queue && (ki() && Mb(this.A, mi), this.A.length = 0)
    };
    ...
    var ni = function () {
        ...
        pi = function (a, b, c, d, e) {
            ...
            if (a instanceof Array) {
                if (d = d || 0, d < c.length) {
                    for (var f = [], g = 0; g < a.length; g++) f.push(pi(a[g], b, c, d + 1, e));
                    return f.join(c[d])
                }
    ...
    var Bi = function (a, b, c, d, e) {
        Ai(a, b, void 0 === c ? null : c, void 0 === d ? !1 : d, void 0 === e ? !1 : e)
    };
    ...
    var Gi = function (a, b, c) {
        b instanceof Og ? (a.left += b.x, a.right += b.x, a.top += b.y, a.bottom += b.y) : (a.left += b, a.right += b, "number" === typeof c && (a.top += c, a.bottom += c));
        return a
    };
    var Hi = function (a, b, c, d) {
            this.left = a;
    ...
    l = Hi.prototype;
    l.contains = function (a) {
        return a instanceof Og ? a.x >= this.left && a.x <= this.left + this.width && a.y >= this.top && a.y <= this.top + this.height : this.left <= a.left && this.left + this.width >= a.left + a.width && this.top <= a.top && this.top + this.height >= a.top + a.height
    };
    l.getSize = function () {
    ...
    var Mi = function () {
        ...
        Si = function () {
            if (Ri) var a = Ri;
                ...
                a =
                    ((a = void 0 === a ? Li() : a) ? Ih(a.master) ? a.master : null : null) || window;
                var b = a.google_persistent_state_async;
                a = null != b && "object" == typeof b && null != b.S && "object" == typeof b.S ? Ri = b : a.google_persistent_state_async = Ri = new Mi
            }
            return Qi(a)
        },
        Ri = null,
        Ti = {},
        Oi = (Ti[8] = "google_prev_ad_formats_by_region", Ti[9] = "google_prev_ad_slotnames_by_region", Ti);
    ...
    l.Sa = function (a, b, c, d, e) {
        ...
        w.error_rep_loaded || (b = w.document, a = Uh("SCRIPT", b), Gh(a, this.I), (b = b.getElementsByTagName("script")[0]) && b.parentNode && b.parentNode.insertBefore(a, b), w.error_rep_loaded = !0);
        return this.j
    };
    l.tb = function (a, b, c) {
        try {
    ...
    var fj = function (a, b, c, d, e, f, g, h) {
        ...
        b.length = 0;
        b.push = m;
        aj(this, "puid", (this.K + 1).toString(36) +
    ...
    var ej = function (a) {
        ...
        jj = function (a, b) {
            ...
            c = $i(c, b, d);
            b = a.g;
            b.google_timing_params && (c = $i(c, b.google_timing_params,
                d), b.google_timing_params = void 0);
            Mb(a.F, function (e) {
                var f = t(e);
                e = f.next().value;
                f = f.next().value;
    ...
    var G = function () {
            this.g = new fj(1, "https:", "csi.gstatic.com", "/csi?v=2&s=", "ima", void 0, !0);
            var a = Si();
        ...
        kj = function (a, b) {
            ...
            var d = !1;
            c = 0;
            for (var e = t(Object.keys(b)), f = e.next(); !f.done; f = e.next()) f =
                f.value, null != a.report[f] && (d = !0), c += gj(a, f, b[f], !1);
            (8E3 < a.o + a.h + c || d) && bj(a);
            d = t(Object.keys(b));
            for (f = d.next(); !f.done; f = d.next()) e = f.value, hj(a, e, b[e], !1);
            a.h += c;
            dj(a)
        },
        J = function (a) {
    ...
    G.prototype.recordClick = function (a, b, c, d) {
        ...
        d = this.g;
        d.j && d.I(new hi(a + "_" + b + "x" + c + "|" + e + "|" + f, 4,
            di(), 0))
    };
    G.g = function () {
        return C(G)
    ...
    var lj = function (a) {
            ...
            if (null ==
                ...
                if ("object" == typeof b) {
                    if (Array.isArray(b)) {
                        ...
                        b = d.length;
                        c.push("[");
                        for (var e = "", f = 0; f < b; f++) c.push(e), e = d[f], pj(a, a.g ? a.g.call(d, String(f), e) : e, c), e = ",";
                        c.push("]");
                        return
                    }
                    if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                        ...
                        c.push("{");
                        f = "";
                        for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (e = b[d], "function" != typeof e && (c.push(f), qj(d, c), c.push(":"), pj(a, a.g ? a.g.call(b, d, e) : e, c), f = ","));
                        c.push("}");
                        return
                    }
                }
        ...
        sj = /\uffff/.test("\uffff") ? /[\\"\x00-\x1f\x7f-\uffff]/g : /[\\"\x00-\x1f\x7f-\xff]/g,
        qj = function (a, b) {
            b.push('"', a.replace(sj, function (c) {
                var d = rj[c];
        ...
        xj = function () {
            ...
            if (null !== b)
                if (lj(b)) {
                    ...
                    e && (a.g = d);
                    "string" !== typeof b ? uj("missing-flags", a.g) : (e || uj("missing-binary-id", a.g), a.j = b)
    ...
    var zj = function (a, b, c, d, e) {
        ...
        L = function (a) {
            var b = Cj;
            if (b.h || b.g.has(a.id) || null == a.C && null == a.control || 0 == a.rf) return b.A;
            var c = b.l;
            if (null != a.control)
    ...
    var Sj = function (a) {
        a = (a.g.cookie || "").split(";");
        for (var b = [], c = [], d, e, f = 0; f < a.length; f++) e = ob(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        return {
            keys: b,
            values: c
        }
    ...
    function ek() {
        var a = fk,
            b = Xe(new Qj(gk), Pj, 2);
        1 == b.length && 16 == jf(b[0], 1) && Xe(b[0], Oj, 2).forEach(function (c) {
            var d = ff(c),
                e = Ve(c, Ij, 3),
                f = a[jf(c, 4)];
    ...
    jk.prototype.g = function (a, b) {
        ...
        var c = [];
        a = [];
        for (var d = t(this.h), e = d.next(); !e.done; e = d.next()) e = e.value, b.get(e) ? c.push(e) : a.push(e);
    ...
    function lk() {
        return mk.split(",").map(function (a) {
    ...
    var Sk, Tk = (null == (Sk = window.document.featurePolicy) ? 0 : Sk.allowedFeatures().includes("attribution-reporting")) ? 300 : 0;
    L({
        id: 44776494,
        C: Tk,
        P: yk
    ...
    var Uk, Vk = (null == (Uk = window.document.featurePolicy) || Uk.allowedFeatures().includes("attribution-reporting"), 0);
    L({
        id: 44769484,
        C: Vk,
        P: zk
    ...
    am.prototype.now = function () {
        return $l() && O.performance.now ? O.performance.now() : Zl.prototype.now.call(this)
    };
    am.prototype.h = function () {
        return $l() && O.performance.memory ? O.performance.memory.totalJSHeapSize || 0 : Zl.prototype.h.call(this)
    };
    am.prototype.j = function () {
        return $l() && O.performance.memory ? O.performance.memory.usedJSHeapSize || 0 : Zl.prototype.j.call(this)
    };
    am.prototype.g = function () {
        return $l() && O.performance.memory ? O.performance.memory.jsHeapSizeLimit || 0 : Zl.prototype.g.call(this)
    };
    var bm = function () {};
    ...
    var cm = function (a, b) {
        ...
        em = function () {
            ...
            !a.url || (e || d) && a != e || (d = Qh(a.url)) && g.push([new cm([d, 1], c(a.depth, b))]);
            g.push([]);
    ...
    var um = function (a, b, c, d, e) {
        if ((d ? a.j : Math.random()) < (e || a.g)) try {
            ...
            else f = new ni, Oh(c, function (h, k) {
                var m = f,
                    n = m.o++;
                ri(m, n, oi(k, h))
            });
    ...
    var zm = function (a) {
        ...
        ym = function (a) {
            Uf.call(this, Error(a), {
                message: a
            })
        };
    u(ym, Uf);
    var wm, Am, vm = new li(1, window),
        Bm = function () {
            O && "undefined" != typeof O.google_measure_js_timing && (O.google_measure_js_timing || vm.B())
        };
    wm = new function () {
        var a = "https:";
    ...
    Am = new xm;
    O && O.document && ("complete" == O.document.readyState ? Bm() : vm.j && dg(O, "load", function () {
        Bm()
    }));
    var Cm = function (a) {
            Am.Sc(function (b) {
    ...
    var ng = {
        ...
        Vm = function (a) {
            ...
            f && (f.IS_GMA_SDK || (e = 2), mg(function (g) {
    ...
    function Xm(a, b, c) {
        try {
            ...
            try {
                var e = (void 0 === c ? 0 : c) ? (new D(d.innerWidth, d.innerHeight)).round() : eh(d || window).round()
            } catch (n) {
    ...
    var Zm = function (a, b) {
        ...
        hn = function (a) {
            var b = gn;
            if ("none" != (bn(a, "display") || (a.currentStyle ? a.currentStyle.display : null) || a.style && a.style.display)) return b(a);
            var c = a.style,
                d = c.display,
                e = c.visibility,
                f = c.position;
        ...
        gn = function (a) {
            var b = a.offsetWidth,
                c = a.offsetHeight,
                d = mc && !b && !c;
            return (void 0 === b || d) && a.getBoundingClientRect ? (a = cn(a), new D(a.right - a.left, a.bottom - a.top)) : new D(b, c)
        },
        mn = function (a) {
            var b = Zg(a),
                c = jc && a.currentStyle;
            if (c && dh($g(b).g) && "auto" != c.width && "auto" != c.height && !c.boxSizing) return b = jn(a, c.width, "width", "pixelWidth"), a = jn(a, c.height, "height", "pixelHeight"), new D(b, a);
            ...
            if (jc) {
                ...
                b = new F(e, d, f, b)
            } else b = bn(a, "paddingLeft"),
                d = bn(a, "paddingRight"), e = bn(a, "paddingTop"), f = bn(a, "paddingBottom"), b = new F(parseFloat(e), parseFloat(d), parseFloat(f), parseFloat(b));
            !jc || 9 <= Number(Hc) ? (d = bn(a, "borderLeftWidth"), e = bn(a, "borderRightWidth"), f = bn(a, "borderTopWidth"), a = bn(a, "borderBottomWidth"), a = new F(parseFloat(f), parseFloat(e), parseFloat(a), parseFloat(d))) : (d = ln(a, "borderLeft"), e = ln(a, "borderRight"), f = ln(a, "borderTop"), a = ln(a, "borderBottom"), a = new F(f, e, a, d));
            return new D(c.width - a.left - b.left - b.right - a.right, c.height - a.top - b.top -
                b.bottom - a.bottom)
        },
        jn = function (a, b, c, d) {
        ...
        kn = function (a, b) {
            return (b = a.currentStyle ? a.currentStyle[b] : null) ? jn(a, b, "left", "pixelLeft") : 0
        },
        nn = {
            thin: 2,
            medium: 4,
    ...
    function pn(a, b, c, d) {
        ...
        d = b(d, a);
        var e = c(d, a);
        return !e && fc(a, "parentElement") ? pn(kh(a), b, c, d) : {
            done: e,
            value: d
        }
    }
    ...
    function wn() {
        var a = vb();
        return a ? Rb("AmazonWebAppPlatform;Android TV;Apple TV;AppleTV;BRAVIA;BeyondTV;Freebox;GoogleTV;HbbTV;LongTV;MiBOX;MiTV;NetCast.TV;Netcast;Opera TV;PANASONIC;POV_TV;SMART-TV;SMART_TV;SWTV;Smart TV;SmartTV;TV Store;UnionTV;WebOS".split(";"), function (b) {
            return qb(a, b)
    ...
    function yn() {
        var a;
        (a = qb(vb(), "CrKey") || qb(vb(), "PlayStation") || qb(vb(), "Roku") || wn() || qb(vb(), "Xbox") || xn()) || (a = vb(), a = qb(a, "sdk_google_atv_x86") || qb(a, "Android TV"));
        return a
    };
    var An = function () {
            this.j = !Ih(O.top);
            this.B = oh() || th();
            var a = Xh();
            a = 0 < a.length && null != a[a.length - 1] && null != a[a.length - 1].url ? ((a = a[a.length - 1].url.match(uh)[3] || null) ? decodeURI(a) : a) || "" : "";
            this.domain = a;
        ...
        zn = function (a) {
            O && O.document && (a.I = Xm(!1, O, a.B), a.g = Xm(!0, O, a.B), Cn(a, O), Bn(a, O))
        },
        En = function () {
            var a = Dn();
    ...
    var Gn = function (a) {
        var b = hm(),
            c = N().g.g;
        a.g = b.setTimeout(nm(c, Em(143, function () {
            a.h++;
            a.j.sample()
        })), Nm())
    };
    ...
    var Jn = function (a, b, c) {
        if (!a.G || (void 0 === c ? 0 : c)) a.G = !0, a.X = b, a.K = 0, a.g != a || In(a)
    };
    ...
    var Mn = function (a) {
            a.D = a.l.length ? Rb(a.l, function (b) {
                return b.Ka()
            }) : !1
        },
        Nn = function (a) {
    ...
    l.Ab = function (a) {
        ...
        b !== this.g ? (this.B = this.g.B, In(this)) : this.B !== this.g.B && (this.B = this.g.B, In(this))
    };
    l.bb = function (a) {
        if (a.h === this.g) {
            var b = this.o,
    ...
    var Un = function (a, b) {
        ...
        Xn = function (a) {
            var b = Wn;
            a.h && (bc(a.g, function (c, d) {
                return Sn(d, c) ? 1 : Sn(c, d) ? -1 : 0
            }), a.h = !1);
            return Qb(a.g, function (c, d) {
                d = b(d);
                return "" + c + ("" != c && "" != d ? "&" : "") + d
            }, "")
        };
    var Wn = function (a) {
        var b = a.h;
        a = a.g;
        return "" === a ? b : "boolean" === typeof a ? a ? b : "" : Array.isArray(a) ? 0 === a.length ? b : b + "=" + a.join() : b + "=" + (Vb(["mtos", "tos", "p"], b) ? a : encodeURIComponent(a))
    };
    var Yn = function (a) {
        var b = void 0 === b ? !0 : b;
        this.g = new Tn;
    ...
    var uo = function () {
            ...
            this.G = this.B = -1;
            this.ha = 1E3;
            this.ba = new jo([1, .9, .8, .7, .6, .5, .4, .3, .2, .1, 0]);
            this.N = this.H = -1
        },
        vo = function (a, b) {
    ...
    function Go(a, b, c) {
        ...
        a = (b.left + b.right) / 2;
        b = (b.top + b.bottom) / 2;
        Ih(window.top) && window.top && window.top.document && (window = window.top);
        if (!Wm()) return !1;
        a = window.document.elementFromPoint(a, b);
        if (!a) return !1;
        b = (b = (b = Zg(c)) && b.defaultView && b.defaultView.frameElement) && Fo(b, a);
        var d = a === c;
        a = !d && a && nh(a, function (e) {
            return e === c
        });
        return !(b || d || a)
    }
    ...
    function Ho(a, b, c, d) {
        return Dn().j ? !1 : 0 >= a.getWidth() || 0 >= a.getHeight() ? !0 : c && d ? Dm(208, function () {
            return Go(a, b, c)
        }) : !1
    };
    ...
    Ko.prototype.L = function () {
        this.ta.g && (this.nb.rd && (eg(this.ta.g, "mouseover", this.nb.rd), this.nb.rd = null), this.nb.qd && (eg(this.ta.g, "mouseout", this.nb.qd), this.nb.qd = null));
        this.Wb && this.Wb.W();
        this.ca && this.ca.W();
        delete this.Jc;
        delete this.od;
    ...
    var Jo = function (a) {
        a = a.ta.ib;
        var b;
        if (b = a && a.getAttribute) b = /-[a-z]/.test("googleAvInapp") ? !1 : Xl && a.dataset ? "googleAvInapp" in a.dataset : a.hasAttribute ? a.hasAttribute("data-" + Vg()) : !!a.getAttribute("data-" + Vg());
        b && (Dn().h = !0)
    };
    ...
    var Lo = function (a, b) {
        ...
        No = function (a, b, c) {
            if (!a.Ac || -1 == a.Bc || -1 === b.getTimestamp() || -1 === a.Ac.getTimestamp()) return 0;
        ...
        Po = function (a) {
            if (a.Kb && a.Wb) {
                ...
                if (b = d.h) {
                    ...
                    f = e.j.g;
                    var h = g = null;
                    null != e.l && f && (g = e.h, g = new Og(g.left -
                        f.left, g.top - f.top), h = new D(f.right - f.left, f.bottom - f.top));
    ...
    l.Md = function (a, b, c, d, e, f, g) {
        this.Pa || (this.Kb && (a = this.Zc(a, c, e, g), d = d && this.pa.Y >= (this.rb() ? .3 : .5), this.Nd(f, a, d), this.Bc = b, 0 < a.Y && -1 === this.Ae && (this.Ae = b), -1 == this.Be && this.Ra() && (this.Be = b), -2 == this.nd && (this.nd = Eo(this.pb()) ? a.Y : -1), this.pa = a), this.od(this))
    };
    l.Nd = function (a, b, c) {
    ...
    var tp = function (a) {
            var b = pg(a.h),
                c = 0,
                d;
            for (d in a.g) Vb(b, d) && 1 == a.g[d] && (c += a.h[d][1], a.g[d] = 2);
            return c
        },
        up = function (a) {
            var b = 0,
    ...
    xp.prototype.K = function (a, b, c, d) {
        if (!b.paused) {
            ...
            vn(b.volume) && (this.o = -1 != this.o ? Math.min(this.o, b.volume) : b.volume, this.A = Math.max(this.A, b.volume));
    ...
    l.Ya = function () {
        ...
        if (this.j && "number" === typeof this.j.videoWidth && "number" === typeof this.j.videoHeight) {
            ...
            var c = a.getWidth(),
                ...
                e = b.width;
            b = b.height;
            0 >= e || 0 >= b || 0 >= c || 0 >= d || (e /= b, a = Fi(a), e > c / d ? (c /= e, d = (d - c) / 2, 0 < d && (d = a.top + d, a.top = Math.round(d), a.bottom = Math.round(d + c))) : (d *= e, c = Math.round((c - d) / 2), 0 < c && (c = a.left + c, a.left = Math.round(c), a.right = Math.round(c + d))));
            this.g = a
        }
        this.ae();
        a = this.g;
        ...
        a = this.h.o;
        b = e = d = 0;
        0 < (this.g.bottom - this.g.top) * (this.g.right - this.g.left) && (this.me(c) ? c = new F(0, 0, 0, 0) : (d = Dn().l, b = new F(0, d.height, d.width, 0), d = Do(c, this.g), e = Do(c, Dn().g), b = Do(c, b)));
        c = c.top >= c.bottom || c.left >= c.right ? new F(0, 0, 0, 0) : Gi(c, -this.g.left, -this.g.top);
        En() || (e = d = 0);
    ...
    l.Ab = function (a) {
        a = a.isActive();
        a !== this.B && (a ? this.o() : (Dn().g = new F(0, 0, 0, 0), this.g = new F(0, 0, 0, 0), this.l = new F(0, 0, 0, 0), this.timestamp = -1));
        this.B = a
    };
    ...
    var Ip = {},
        Jp = (Ip.firstquartile = 0, Ip.midpoint = 1, Ip.thirdquartile = 2, Ip.complete = 3, Ip),
    ...
    l.Md = function (a, b, c, d, e, f, g) {
        ...
        this.Ta && this.Ta.j && Mb(this.A, function (m) {
            m.h(h)
        })
    };
    l.Nd = function (a, b, c) {
        ...
        this.ba = Wo(this.pa) && Wo(b); - 1 == this.U && this.ha && (this.U = this.oa().j.g);
        this.fa.j = 0;
        a = this.Ra();
        ...
        this.Bb && this.fa.reportEvent("f"); - 1 != b.h && (this.fa.reportEvent("bm"), 1 == b.h && (this.fa.reportEvent("b"), Wo(b) && this.fa.reportEvent("umutb")));
        Wo(b) && b.isVisible() &&
            this.fa.reportEvent("avs");
    ...
    Kp.prototype.Zc = function (a, b, c, d) {
        ...
        a.paused = 2 == this.ka;
        a.volume = c.volume;
        vn(a.volume) || (this.Fa++, b = this.pa, vn(b.volume) && (a.volume = b.volume));
        c = c.currentTime;
    ...
    var Rp = function (a, b) {
        ...
        Qp = function (a, b, c) {
            return 15E3 <= b ? !0 : a.ha ? (void 0 === c ? 0 : c) ? !0 : 0 < a.j ? b >= a.j / 2 : 0 < a.U ? b >= a.U : !1 : !1
        },
        Tp = function (a) {
            var b = {},
                c = Dn();
        ...
        Yp = function (a, b, c, d, e) {
            ...
            n.vmtime = a.G;
            n.is = a.fa.j;
            1 <= a.g.length && (n.i0 = a.g[0].Pb, n.a0 = [a.g[0].Hb], n.c0 = [a.g[0].Y], n.ss0 = [a.g[0].sa], f = a.g[0].position,
                n.p0 = f ? Hp(f) : void 0);
            2 <= a.g.length && (n.i1 = a.g[1].Pb, n.a1 = $p(a.g[1].Kc, a.g[1].Hb, a.g[1].Gc), n.c1 = $p(a.g[1].Lc, a.g[1].Y, a.g[1].Hc), n.ss1 = $p(a.g[1].Mc, a.g[1].sa, a.g[1].Ic), f = a.g[1].position, n.p1 = f ? Hp(f) : void 0, n.mtos1 = a.g[1].Nc);
            3 <= a.g.length && (n.i2 = a.g[2].Pb, n.a2 = $p(a.g[2].Kc, a.g[2].Hb, a.g[2].Gc), n.c2 = $p(a.g[2].Lc, a.g[2].Y, a.g[2].Hc), n.ss2 = $p(a.g[2].Mc, a.g[2].sa, a.g[2].Ic), f = a.g[2].position, n.p2 = f ? Hp(f) : void 0, n.mtos2 = a.g[2].Nc);
            4 <= a.g.length && (n.i3 = a.g[3].Pb, n.a3 = $p(a.g[3].Kc, a.g[3].Hb, a.g[3].Gc),
                n.c3 = $p(a.g[3].Lc, a.g[3].Y, a.g[3].Hc), n.ss3 = $p(a.g[3].Mc, a.g[3].sa, a.g[3].Ic), f = a.g[3].position, n.p3 = f ? Hp(f) : void 0, n.mtos3 = a.g[3].Nc);
            n.cs = up(a.fa);
            b && (n.ic = tp(a.fa), n.dvpt = k.j.h, n.dvs = qo(k.h, .5), n.dfvs = qo(k.h, 1), n.davs = qo(k.g, .5), n.dafvs = qo(k.g, 1), c && (k.j.h = 0, ro(k.h), ro(k.g)), a.Ra() && (n.dtos = k.J, n.dav = k.D, n.dtoss = a.gd + 1, c && (k.J = 0, k.D = 0, a.gd++)), n.dat = k.l.h, n.dft = k.F.h, c && (k.l.h = 0, k.F.h = 0));
            n.ps = [g.o.width, g.o.height];
            n.bs = [g.g.getWidth(), g.g.getHeight()];
            n.scs = [g.l.width, g.l.height];
            n.dom = g.domain;
            a.Fb && (n.vds = a.Fb);
            if (0 < a.A.length || a.Ta) b = $b(a.A), a.Ta && b.push(a.Ta), n.pings = Pb(b, function (q) {
                return q.toString()
            });
            b = Pb(Ob(a.A, function (q) {
                return q.A()
            }), function (q) {
                return q.getId()
            });
            ...
            a.ca && zg(n, a.ca.ab());
            d ? (n.c = on(a.pa.Y, 2), n.ss = on(a.pa.sa, 2)) : n.tth = Mm() - Jm;
            n.mc = on(k.G, 2);
            n.nc = on(k.B, 2);
            n.mv = Mp(k.A);
            n.nv = Mp(k.o);
    ...
    var aq = Date.now(),
        dq = function () {
            ...
            try {
                if ("1" == b) {
                    for (var c = a.parent; c != a.top; c = c.parent) bq(this, c, c.document);
        ...
        bq = function (a, b, c) {
            Bo(c, "mousedown", function () {
                return eq(a)
            }, 301);
            Bo(b, "scroll", function () {
                return fq(a)
            }, 302);
            Bo(c, "touchmove", function () {
                return gq(a)
            }, 303);
            Bo(c, "mousemove", function () {
                return hq(a)
            }, 304);
            Bo(c, "keydown", function () {
                return iq(a)
            }, 305)
        },
        eq = function (a) {
    ...
    var Aq = function (a) {
        ...
        zq = function (a) {
            ...
            var b = a.j,
                c = a.h.g.j,
                d = N().g.g;
            a.o = new c.IntersectionObserver(nm(d, function (e) {
                return Bq(a, e)
            }), xq);
            d = nm(d, function () {
                a.o.unobserve(b);
            ...
            c.ResizeObserver ? (a.B = new c.ResizeObserver(d), a.B.observe(b)) : c.MutationObserver && (a.A = new w.MutationObserver(d), a.A.observe(b, {
                attributes: !0,
                childList: !0,
                characterData: !0,
                subtree: !0
    ...
    l.ab = function () {
        var a = {};
        return Object.assign(this.h.ab(), (a.niot_obs = this.D, a.niot_cbk = this.K, a))
    };
    l.getName = function () {
        return "nio"
    };
    ...
    Fq.prototype.F = function () {
        var a = Eq();
        this.K !== a && (this.g != this && a > this.g.K && (this.g = this, In(this)), this.K = a);
        return 2 == a
    };
    var Eq = function () {
        N();
    ...
    Hq.prototype.o = function () {
        var a = En(),
            b = Mm();
        a ? (Lm || (Hm = b, Mb(nq.g, function (c) {
            var d = c.oa();
            d.V = yp(d, b, 1 != c.ka)
        })), Lm = !0) : (this.B = Nq(this, b), Lm = !1, Jm = b, Mb(nq.g, function (c) {
            c.Kb && (c.oa().I = b)
        }));
        Lq(this, oq(), !a)
    };
            ...
            Cm([function (b) {
                ...
                if (!Iq.j) {
                    ...
                    try {
                        ...
                        } else n.url = encodeURIComponent(O.location.href.substring(0, 512)), f.referrer && (n.referrer = encodeURIComponent(f.referrer.substring(0, 512)));
                        n.tt = g;
                        n.pt = Im;
                        n.bin = m.h;
                        void 0 !== O.google_osd_load_pub_page_exp && (n.olpp = O.google_osd_load_pub_page_exp);
                        n.deb = [1, e.g.lf, e.g.Yd, e.g.ee, e.g.ld, 0, e.h.h, e.g.tf, e.g.sf, e.g.uf, e.g.lg, -1].join(";");
                        n.tvt = Nq(e, h);
                        k.h && (n.inapp = 1);
                        if (null !== O && O != O.top) {
                            0 < q.length && (n.iframe_loc = encodeURIComponent(O.location.href.substring(0,
                                512)));
                            var x = k.I;
                ...
                if (1 == Rl(H.j, "prf")) {
                    v = new lm;
                    x = H.g;
                    e = 0; - 1 < x.g && (e = x.j.g.now() - x.g);
                    x = x.o + e;
                    if (null != x && "number" !== typeof x) throw Error("Value of float/double field must be a number, found " + typeof x + ": " + x);
                    v = Se(v, 1, x, 0);
                    x = H.g;
    ...
    var ar = {
        ...
        dr = function (a) {
            try {
                var b = a.split(",");
                return b.length > pg(ar).length ? null : Qb(b, function (c, d) {
                    d = d.toLowerCase().split("=");
                    if (2 != d.length || void 0 ===
                        br[d[0]] || !br[d[0]](d[1])) throw Error("Entry (" + d[0] + ", " + d[1] + ") is invalid.");
                    c[d[0]] = d[1];
                    return c
                }, {})
            } catch (c) {
    ...
    qr.prototype.initialize = function () {
        ...
        Dn().K = !0;
        this.j.document.readyState && "complete" == this.j.document.readyState ? sr(this) : Bo(this.j, "load", function () {
            hm().setTimeout(Em(292, function () {
                return sr(a)
            }), 100)
        }, 292);
        return !0
    ...
    var sr = function (a) {
        ...
        vr = function (a) {
            "string" === typeof a.h.Ba.AFMA_LIDAR ? (a.J = !0, wr(a)) : (a.h.rc = 3, a.I = "nc", Jn(a, "w"))
        },
        wr = function (a) {
            a.H = !1;
            var b = 1 == Rl(N().R, "rmmt"),
                c = !!a.A("isViewable");
            (b ? !c : 1) && hm().setTimeout(Em(524, function () {
        ...
        yr = function (a) {
            var b = 1 == Rl(N().R, "sneio"),
                ...
                d =
                void 0 !== a.h.Ba.AFMA_LIDAR_EXP_2;
    ...
    var Cr = function () {
        ...
        this.g = this.h = null;
        var a = {};
        this.J = (a.start = this.Lf, a.firstquartile = this.Gf, a.midpoint = this.If, a.thirdquartile = this.Mf, a.complete = this.Df, a.error = this.Ef, a.pause = this.wd, a.resume = this.we, a.skip = this.Kf, a.viewable_impression = this.Ja, a.mute = this.Eb, a.unmute = this.Eb, a.fullscreen = this.Hf, a.exitfullscreen = this.Ff, a.fully_viewable_audible_half_duration_impression = this.Ja, a.measurable_impression = this.Ja, a.abandon = this.wd, a.engagedview = this.Ja, a.impression = this.Ja, a.creativeview =
            this.Ja, a.progress = this.Eb, a.custom_metric_viewable = this.Ja, a.bufferstart = this.wd, a.bufferfinish = this.we, a.audio_measurable = this.Ja, a.audio_audible = this.Ja, a);
        a = {};
        this.U = (a.overlay_resize = this.Jf, a.abandon = this.kd, a.close = this.kd, a.collapse = this.kd, a.overlay_unmeasurable_impression = function (b) {
            ...
            return Zp(b,
                "overlay_unviewable_impression", En())
    ...
    var Er = function (a, b, c) {
            ...
            Mb(b, function (e) {
                var f = Pb(e.j, function (g) {
                    var h = dr(g);
                    if (null == h) g = null;
                    else if (g = new cr, null != h.visible && (g.g = h.visible / 100), null != h.audible && (g.h = 1 == h.audible), null != h.time) {
            ...
            if (!a.ua) {
                ...
                try {
                    ...
                    if (im()) {
                        ...
                        uq(f, function () {
                            Gr()
                        }) ? Iq.done || (Oq(), Kn(f.g.g, a), Kq()) : d.j ? Gr() : Kq()
                    } else Sq = !0
                } catch (g) {
                    throw nq.reset(), g;
                }
    ...
    var Lr = function (a, b) {
        if (!a.Ma) {
            ...
            b = "//pagead2.googlesyndication.com/pagead/gen_204?" + Xn(Vn(new Tn, d));
            $n(b);
            a.Ma = !0
        }
    };
    ...
    var Br = function (a) {
        ...
        Or = function (a, b, c, d) {
            ...
            e || (b = a.A(c, Mm(), !1, b), 0 == nq.h.length && (N().j = 79463069), sq([b]), e = b, e.l = Jr(a), d && (e.playerId = d));
            return e
        };
    ...
    var Pr = function (a, b) {
        ...
        Nr = function () {
            var a = Dn(),
                ...
                c = {},
                d = {};
            return Object.assign({}, (b.sv = "960", b), null !== Xq && (c.v = Xq, c), (d["if"] = a.j ? "1" : "0", d.nas = String(nq.g.length), d))
        };
    var Rr = function (a) {
    ...
    Vr.prototype.report = function (a, b) {
        ...
        if ("function" === typeof c) {
            var d = {};
            var e = {};
            d = Object.assign({}, null !== Xq && (d.v = Xq, d), (e.sv = "960", e.cb = Wq, e.e = Wr(a), e));
            e = Zp(b, a, En());
            zg(d, e);
            b.De[a] = e;
    ...
    Yr.prototype.I = function (a, b) {
        ...
        e || (b.opt_overlayAdElement ? e = void 0 : b.opt_adElement && (e = Or(this, a, b.opt_adElement, b.opt_osdId)));
        e && 1 == e.wa() && (e.B == Yf && (e.B = function (f) {
            return c.Td(f)
        }), bs(this, e, b));
        return e
    };
    ...
    Yr.prototype.Td = function (a) {
        ...
        a.h || (void 0 === d ? a.h |= 8 : null === d ? a.h |= 16 : vg(d) ? a.h |= 32 : null != d.errorCode && (a.N = d.errorCode, a.h |= 64));
        null == d && (d = {});
        Qr(d, a);
    ...
    var $r = function (a, b, c) {
            var d = kq(nq, b);
            d || (d = c.opt_nativeTime || -1, d = Dr(a, b, Jr(a), d), c.opt_osdId && (d.playerId = c.opt_osdId));
            return d
        },
        Zr = function (a, b, c) {
            var d = kq(nq, b);
    ...
    Yr.prototype.fd = function () {
        if (cs(this)) return new Xr("ima.common.triggerExternalActivityEvent", this.o);
        var a = es(this);
    ...
    Yr.prototype.Cd = function (a) {
        !a.g && a.Pa && Kr(this, a, "overlay_unmeasurable_impression") && (a.g = !0)
    };
    Yr.prototype.ue = function (a) {
        a.xe && (a.Ra() ? Kr(this, a, "overlay_viewable_end_of_session_impression") : Kr(this, a, "overlay_unviewable_impression"), a.xe = !1)
    };
    var fs = function (a, b, c, d) {
        ...
        if (void 0 !== d)
            ...
            b: {
                "i" == Rq && (b.Pa = !0, a.Gd(b));f = e.opt_fullscreen;void 0 !== f && Lo(b, !!f);
                var g;
                if (f = !Dn().h && !yn()) hm(),
                f = 0 === Wi(Wl);
                if (g = f) {
                ...
                if (g = !g) c: {
                    if (Rl(N().R,
                            "ssmol") && (g = a.j, "loaded" === f)) break c;g = Vb(Rm, f)
                }
                if (g && 0 == b.ka) {
                    "i" != Rq && (Iq.done = !1);
                    ...
                    h || (b.oa().I = g);
                    Lq(Iq, [b], !h)
                }(g = b.wb[f]) && b.fa.reportEvent(g);Rl(N().R, "fmd") || Vb(Sm, f) && b.Ta && b.Ta.h(b, null);
                switch (b.wa()) {
                    case 1:
                ...
                if (k && (d = k.call(a, b, e, d), Rl(N().R, "fmd") && Vb(Sm, f) && b.Ta && b.Ta.h(b, null), void 0 !== d)) {
                    e = Zq(void 0, f);
                    zg(e, d);
                    d = e;
                    break b
        ...
        else Sq ? a = Zq("ue") : f ? (a = Zq(), zg(a, Yp(f, !0, !1, !1))) : a = Zq("nf");
    ...
    Yr.prototype.A = function (a, b, c, d) {
        if (rm()) {
            var e = Rl(N().R, "mm"),
                f = {};
            (e = (f[Al.Ge] = "ACTIVE_VIEW_TRAFFIC_TYPE_AUDIO", f[Al.kf] = "ACTIVE_VIEW_TRAFFIC_TYPE_VIDEO", f)[e]) && e && (this.B = e);
            "ACTIVE_VIEW_TRAFFIC_TYPE_UNSPECIFIED" === this.B && Fm(1044, Error())
        }
        a = Cr.prototype.A.call(this, a, b, c, d);
        this.K && (b = this.F, null == a.o && (a.o = new To), b.g[a.la] = a.o, a.o.l = aq);
        return a
    };
    ...
    Yr.prototype.de = function () {
        this.g || (this.g = this.fd());
        return null == this.g || this.j ? new Dp : "ACTIVE_VIEW_TRAFFIC_TYPE_AUDIO" === this.B ? new Tr(this.g) : new lr(this.g)
    };
    ...
    w.console && "function" === typeof w.console.log && Za(w.console.log, w.console);
    var ps = function (a) {
    ...
    ts.prototype.init = function (a, b) {
        ...
        (b = a.relatedTarget) ? lc && (fc(b, "nodeName") || (b = null)): "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement);
        ...
        this.pointerType = "string" === typeof a.pointerType ? a.pointerType : us[a.pointerType] || "";
        this.state = a.state;
        this.g = a;
    ...
    As.prototype.add = function (a, b, c, d, e) {
        ...
        a = this.g[f];
        a || (a = this.g[f] = [], this.h++);
        var g = Bs(a, b, d, e); - 1 < g ? (b = a[g], c || (b.hc = !1)) : (b = new ys(b, this.src, f, !!d, e), b.hc = c, a.push(b));
        return b
    };
    ...
    var Cs = function (a, b) {
        var c = b.type;
        c in a.g && Wb(a.g[c], b) && (zs(b), 0 == a.g[c].length && (delete a.g[c], a.h--))
    };
    ...
    var Ds = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Hs = function (a, b, c, d, e) {
            ...
            c = Is(c);
            return ws(a) ? a.O(b, c, Qa(d) ? !!d.capture : !!d, e) : Js(a, b, c, !1, d, e)
        },
        Js = function (a, b, c, d, e, f) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) rs || (e = g), void 0 ===
        ...
        Gs = function (a, b, c, d, e) {
            ...
            c = Is(c);
            return ws(a) ? a.Qb(b, c, Qa(d) ? !!d.capture : !!d, e) : Js(a, b, c, !0, d, e)
        },
        Os =
        function (a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) Os(a, b[f], c, d, e);
            else d = Qa(d) ? !!d.capture : !!d, c = Is(c), ws(a) ? a.vb(b, c, d, e) : a && (a = Ks(a)) && (b = a.Mb(b, c, d, e)) && Ps(b)
        },
        Ps = function (a) {
            if ("number" !== typeof a && a && !a.Ub) {
                ...
                if (ws(b)) Cs(b.o, a);
                    ...
                    var c = a.type,
                        d = a.proxy;
                    b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b.detachEvent(Ms(c), d) : b.addListener && b.removeListener && b.removeListener(d);
                    Fs--;
                    (c = Ks(b)) ? (Cs(c, a), 0 == c.h && (c.src = null, b[Ds] = null)) : zs(a)
                }
            }
        },
        Ms = function (a) {
    ...
    l.dispatchEvent = function (a) {
        ...
        a.h || (g = a.currentTarget = c, e = Rs(g, d, !0, a) && e, a.h || (e = Rs(g, d, !1, a) && e));
        if (b)
            for (f = 0; !a.h && f < b.length; f++) g = a.currentTarget = b[f], e = Rs(g, d, !1, a) && e;
        return e
    };
    l.L = function () {
        Q.Da.L.call(this);
    ...
    var Zs, $s = !1,
        ...
        bt = function () {
            if (w.Promise && w.Promise.resolve) {
                ...
                var b = dt;
                "function" !== typeof w.setImmediate || w.Window && w.Window.prototype && (zb() || !z("Edge")) && w.Window.prototype.setImmediate == w.setImmediate ? (Us || (Us = Vs()), Us(b)) : w.setImmediate(b)
            }
        },
        dt = function () {
    ...
    gt.prototype.then = function (a, b, c) {
        return kt(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
            ...
            if (0 == a.g)
                if (a.j) {
                    ...
                    if (c.h) {
                        ...
                        e && (0 == c.g && 1 == d ? mt(c, b) : (f ? (d = f, d.next == c.o && (c.o = d), d.next = d.next.next) : nt(c), ot(c, e, 3, b)))
                    }
                    a.j = null
                } else ft(a, 3, b)
        },
    ...
    var ft = function (a, b, c) {
            if (0 == a.g) {
                ...
                g || (a.B = c, a.g = b, a.j = null, pt(a), 3 != b || c instanceof lt || tt(a, c))
            }
        },
    ...
    l.ng = function () {
        if (this.enabled) {
            ...
            0 < a && a < .8 * this.h ? this.La = this.g.setTimeout(this.j, this.h - a) : (this.La && (this.g.clearTimeout(this.La), this.La = null), this.dispatchEvent("tick"), this.enabled && (this.stop(), this.start()))
        }
    };
    l.start = function () {
        this.enabled = !0;
        this.La || (this.La = this.g.setTimeout(this.j, this.h), this.l = Date.now())
    };
    l.stop = function () {
        this.enabled = !1;
    ...
    var xt = function (a, b, c) {
            ...
            else if (a && "function" == typeof a.handleEvent) a = Za(a.handleEvent, a);
    ...
    var Kt = function (a) {
            var b = new Hi(-Number.MAX_VALUE / 2, -Number.MAX_VALUE / 2, Number.MAX_VALUE, Number.MAX_VALUE),
                c = new Hi(0, 0, 0, 0);
        ...
        Lt = function (a, b) {
            ...
            a = en(a,
                b);
            return new Hi(Math.round(a.x), Math.round(a.y), Math.round(c.right - c.left), Math.round(c.bottom - c.top))
        },
        Mt = function (a, b, c) {
            if (b && c) {
                a: {
                ...
                e = d ? d.height * d.width : 0;f = d ? b.height * b.width : 0;d = d && f ? Math.round(e / f * 100) : 0;Ft(a, new Gt("vp", d));d && 0 < d ? (e = Ii(b), f = Ii(c), e = e.top >= f.top && e.top < f.bottom) : e = !1;Ft(a, new Ht(512,
                    e));d && 0 < d ? (e = Ii(b), f = Ii(c), e = e.bottom <= f.bottom && e.bottom > f.top) : e = !1;Ft(a, new Ht(1024, e));d && 0 < d ? (e = Ii(b), f = Ii(c), e = e.left >= f.left && e.left < f.right) : e = !1;Ft(a, new Ht(2048, e));d && 0 < d ? (b = Ii(b), c = Ii(c), c = b.right <= c.right && b.right > c.left) : c = !1;Ft(a, new Ht(4096, c))
            }
        };
    var Nt = function (a, b) {
        var c = 0;
        ...
        if (d) {
            ...
            Ft(a, new Ht(64, "hidden" != e.toLowerCase().substring(e.length - 6) ? !0 : !1));
            try {
                var f = E().top;
                try {
            ...
            m ? (h = fh($g(h.document).g), Ft(a, new Ht(16384, !!h)), m = h ? new Hi(h.x, h.y, m.width, m.height) : null) : m = null;
            Ft(a, new It("vi", m));
            if (m && "1" == k) {
                k = ps(d);
                d = [];
        ...
        if (c && (c = qg(E(), "ima", "video", "client"), c.getEData)) {
            ...
            if (c = qg(E(), "ima", "video", "client", "getLastSnapshotFromTop"))
                if (a = c()) this.h.extendWithDataFromTopIframe(a.tagstamp, a.playstamp, a.lactstamp), c = this.j, b = a.er, a = a.vi, b && a &&
                    (b = Jt(b).getValue(), a = Jt(a).getValue(), k = null, xg(c.g, "er", null) && (k = xg(c.g, "er", null).getValue(), k.top += b.top, k.left += b.left, Ft(c, new It("er", k))), xg(c.g, "vi", null) && (m = xg(c.g, "vi", null).getValue(), m.top += b.top, m.left += b.left, d = [], d.push(m), d.push(b), d.push(a), b = Kt(d), Mt(c, k, b), Ft(c, new It("vi", a))));
            a: {
                if (this.h) {
    ...
    (function (a) {
        ...
        Hu.Sc(function () {});
        Hu.Jd(!0);
        "complete" == window.document.readyState ? window.google_measure_js_timing || vi.B() : vi.j && dg(window, "load", function () {
    ...
    var nv = function (a) {
        ...
        qv = function (a) {
            return String.fromCharCode(kv + ov(a, 6)) + String.fromCharCode(kv + ov(a, 6))
        },
        uv = function (a) {
            var b = ov(a, 16);
            return !0 === !!ov(a, 1) ? (a = rv(a), a.forEach(function (c) {
    ...
    var xv = function (a) {
        try {
            var b = Qc(a).map(function (d) {
                ...
                c = new nv(b);
            return iv(hv(gv(fv(ev(dv(cv(bv(av($u(Zu(Yu(Xu(Wu(Vu(Uu(Tu(Su(Ru(new Qu, ov(c, 6)), pv(c)), pv(c)), ov(c, 12)), ov(c, 12)), ov(c, 6)), qv(c)), ov(c, 12)), ov(c, 6)), !!ov(c, 1)), !!ov(c, 1)), tv(c, 12, mv)), tv(c, 24, lv)), tv(c, 24, lv)), !!ov(c, 1)), qv(c)), uv(c)), uv(c)), vv(c))
        } catch (d) {
            return null
        }
    };
    var zv = function (a) {
            ...
            b.shift();
            b = t(b);
            for (c = b.next(); !c.done; c = b.next()) switch (c = c.value, yv(c)) {
                case 1:
                case 2:
                    break;
                case 3:
    ...
    var Gv = function (a) {
        ...
        else if (2 & g || 2048 & g) b = vd(b), e = 1, f && (e |= 32), Ad(b, e), Ke(c, d, 1, b, !1);
        c = b;
        d = zd(c);
        d = !!(4 & d) && !!(4096 & d);
        if (Array.isArray(a))
            for (b = 0; b < a.length; b++) c.push(ce(a[b], d));
        else
            for (a = t(a), b = a.next(); !b.done; b = a.next()) c.push(ce(b.value, d))
    };
    Fv.ga = [1];
    ...
    function Mv(a) {
        return new(Function.prototype.bind.apply(a, [null].concat(ha(Ia.apply(1, arguments)))))
    };
    ...
    var Yv = function (a, b) {
        ...
        c = c.timeoutMs;
        P.call(this);
        this.caller = new Nv(a, b && 1 !== b && 3 !== b ? "__gppLocator_non_existent" : "__gppLocator", b && 1 !== b && 2 !== b ? void 0 : function (d) {
    ...
    Yv.prototype.removeEventListener = function (a) {
        Qv(this.caller, "removeEventListener", {
            listenerId: a
        })
    };
    var aw = {
    ...
    var ew = function (a) {
        ...
        hw = function (a, b) {
            ...
            fw(a, "addEventListener", function (f) {
                f && (c = f, c.internalErrorState = bw(c), c.internalBlockOnErrors = a.l, gw(c) ? (0 != c.internalErrorState && (c.tcString = "tcunavailable"), fw(a, "removeEventListener", null, c.listenerId), (f = e) && clearTimeout(f),
    ...
    cw.prototype.addEventListener = function (a) {
        ...
        var f = function (g, h) {
            clearTimeout(e);
            g ? (c = g, c.internalErrorState = bw(c), c.internalBlockOnErrors = b.l, h && 0 === c.internalErrorState || (c.tcString = "tcunavailable", h || (c.internalErrorState = 3))) : (c.tcString = "tcunavailable", c.internalErrorState = 3);
            a(c)
        };
        try {
    ...
    var fw = function (a, b, c, d) {
        ...
        gw = function (a) {
            ...
            return "error" === a.cmpStatus || 0 !== a.internalErrorState ? a.internalBlockOnErrors ? (Di({
    ...
    var R = function (a, b) {
        ...
        this.l = !1;
        var c;
        a instanceof R ? (this.l = void 0 !== b ? b : a.l, jw(this, a.o), this.A = a.A, this.h = a.h, kw(this, a.I), this.j = a.j, lw(this, mw(a.g)), this.K = a.D()) : a && (c = String(a).match(uh)) ? (this.l = !!b, jw(this, c[1] || "", !0), this.A = nw(c[2] || ""), this.h = nw(c[3] || "", !0), kw(this, c[4]), this.j = nw(c[5] || "", !0), lw(this, c[6] || "", !0), this.K = nw(c[7] || "")) : (this.l = !!b, this.g = new ow(null, this.l))
    };
    R.prototype.toString = function () {
        ...
        b && a.push(pw(b, qw, !0), ":");
        var c = this.h;
        if (c || "file" == b) a.push("//"), (b = this.A) && a.push(pw(b, qw, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.I, null != c && a.push(":", String(c));
        if (c = this.j) this.h && "/" != c.charAt(0) && a.push("/"), a.push(pw(c, "/" == c.charAt(0) ? rw : tw, !0));
    ...
    var jw = function (a, b, c) {
        ...
        lw = function (a, b, c) {
            b instanceof ow ? (a.g = b, vw(a.g, a.l)) : (c || (b = pw(b, ww)), a.g = new ow(b, a.l))
        },
        xw = function (a, b, c) {
            a.g.set(b, c);
            return a
    ...
    var yw = function (a) {
        ...
        pw = function (a, b, c) {
            return "string" === typeof a ? (a = encodeURI(a).replace(b, zw), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
        },
        zw = function (a) {
            a = a.charCodeAt(0);
        ...
        Aw = function (a) {
            a.g ||
                (a.g = new Map, a.h = 0, a.j && wh(a.j, function (b, c) {
                    a.add(Pg(b), c)
                }))
        };
    ...
    l.zb = function (a) {
        Aw(this);
        var b = [];
        if ("string" === typeof a) Cw(this, a) && (b = b.concat(this.g.get(Bw(this, a))));
        else {
    ...
    var mw = function (a) {
        ...
        vw = function (a, b) {
            b && !a.o && (Aw(a), a.j = null, a.g.forEach(function (c, d) {
                var e = d.toLowerCase();
                d != e && (this.remove(d), this.remove(e), 0 < c.length && (this.j = null, this.g.set(Bw(this, e), $b(c)), this.h += c.length))
            }, a));
            a.o = b
        };
    var Dw, Ew, Fw, Gw = function () {
            return w.navigator ? w.navigator.userAgent : ""
        },
        Hw = pb(Gw(), "(iPad") || pb(Gw(), "(Macintosh") || pb(Gw(), "(iPod") || pb(Gw(), "(iPhone");
    var Iw = "ad.doubleclick.net bid.g.doubleclick.net ggpht.com google.co.uk google.com googleads.g.doubleclick.net googleads4.g.doubleclick.net googleadservices.com googlesyndication.com googleusercontent.com gstatic.com gvt1.com prod.google.com pubads.g.doubleclick.net s0.2mdn.net static.doubleclick.net surveys.g.doubleclick.net youtube.com ytimg.com".split(" "),
        Jw = ["c.googlesyndication.com"];

    function Kw(a, b) {
        b = void 0 === b ? window.location.protocol : b;
        var c = !1;
        null == a || !a.startsWith("http") || (null == a ? 0 : a.startsWith("https")) ? c = !1 : Lw(a, Jw) ? c = !1 : b.includes("https") && Lw(a, Iw) && (c = !0);
        return c ? (a = new R(a), I(G.g(), "htp", "1"), jw(a, "https"), a.toString()) : a
    }
    ...
    function Qw(a, b) {
        ...
        if (!nb(Sg(a))) {
            ...
            a = window;
            if (d instanceof Fg) var f = d instanceof Fg && d.constructor === Fg ? d.g : "type_error:SafeUrl";
            else {
                b: if (Eh) {
                    try {
                        f = new URL(d)
    ...
    var Zw = function (a) {
        !a.g.enabled && a.A && (a.D = 1E3 * Yw(a), a.B = Date.now(), a.l = !1, a.g.start())
    };
    ...
    var $w = "://secure-...imrworldwide.com/ ://cdn.imrworldwide.com/ ://aksecure.imrworldwide.com/ ://[^.]*.moatads.com ://youtube[0-9]+.moatpixel.com ://pm.adsafeprotected.com/youtube ://pm.test-adsafeprotected.com/youtube ://e[0-9]+.yt.srs.doubleverify.com www.google.com/pagead/xsul www.youtube.com/pagead/slav".split(" "),
        ax = /\bocr\b/;
    ...
    function ex(a, b, c, d) {
        var e = hn(a);
        b.width <= e.width && b.height <= e.height ? (fx(d), c(e)) : (e = setTimeout(function () {
            return ex(a, b, c, d)
        }, 200), d.h = e)
    }
            ...
            d = new Promise(function (e) {
                ...
                "ResizeObserver" in window ? (f = new ResizeObserver(function (g) {
                    window.requestAnimationFrame(function () {
                        for (var h = new D(0, 0), k = t(g), m = k.next(); !m.done; m = k.next())
                            if (m = m.value, m.contentBoxSize ? (m = Array.isArray(m.contentBoxSize) ? m.contentBoxSize[0] : m.contentBoxSize, h.width = Math.floor(m.inlineSize), h.height = Math.floor(m.blockSize)) : (h.width = Math.floor(m.contentRect.width),
                                    h.height = Math.floor(m.contentRect.height)), b.width <= h.width && b.height <= h.height) return fx(c), e(h)
                    })
                }), c.g = f, f.observe(a)) : ex(a, b, e, c)
            });
        cx.set(d, c);
        return d
    }
    ...
    function ix(a) {
        ...
        a.split(",").forEach(function (c) {
            var d = c.split("=");
            2 == d.length && (c = ob(d[0]), d = ob(d[1]), 0 < c.length && (b[c] = d))
        });
        return b
    }
    ...
    rx.prototype.vb = function (a, b, c, d, e) {
        ...
        else c = c || this.handleEvent, d = Qa(d) ? !!d.capture : !!d, e = e || this.o || this, c = Is(c), d = !!d, b = ws(a) ? a.Mb(b, c, d, e) : a ? (a = Ks(a)) ? a.Mb(b, c, d, e) : null : null, b && (Ps(b), delete this.h[b.key])
    };
    var vx = function (a) {
        kg(a.h, function (b, c) {
    ...
    var Dx = /^https?$/i,
        ...
        Ix = function (a, b, c, d) {
            ...
            !Vb(Ex, c) || e || f || d.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
            c = t(d);
            ...
            try {
                Gx(a), 0 < a.D && (a.U = Hx(a.g), a.U ? (a.g.timeout = a.D, a.g.ontimeout = Za(a.aa, a)) : a.B = xt(a.aa, a.D, a)), a.A = !0, a.g.send(b), a.A = !1
            } catch (g) {
                Fx(a)
            }
        },
        Hx = function (a) {
            return jc && "number" === typeof a.timeout &&
                void 0 !== a.ontimeout
        };
    ...
    Cx.prototype.abort = function (a) {
        this.g && this.h && (this.h = !1, this.j = !0, this.g.abort(), this.j = !1, this.l = a || 7, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Kx(this))
    };
    Cx.prototype.L = function () {
        this.g && (this.h && (this.h = !1, this.j = !0, this.g.abort(), this.j = !1), Kx(this, !0));
        Cx.Da.L.call(this)
    };
    ...
    var Lx = function (a) {
            if (a.h && "undefined" != typeof La && (!a.F[1] || 4 != Mx(a) || 2 != Nx(a)))
                ...
                try {
                    ...
                    d ? (a.dispatchEvent("complete"),
                        a.dispatchEvent("success")) : (a.l = 6, Jx(a))
                } finally {
                    Kx(a)
                }
            }
    ...
    var yy = function (a) {
            ...
            return zy({
                ...
                return h instanceof Error && 6 == h.message && d ? zy({
                    url: b,
                    timeout: c,
                    withCredentials: !d,
                    method: e,
            ...
            return new Promise(function (m, n) {
                k.Qb(g, "success", function () {
                    a: {
                        ...
                        g.g && 4 == Mx(g) ? (q = g.g.getResponseHeader("Content-Type"), q = null === q ? void 0 : q) : q = void 0;q = q || ""
                    }
                    if (-1 != q.indexOf("application/json")) m(Ox(g) || {});
                        ...
                        if (null ==
                            ...
                            r = v;
                            if ("undefined" != typeof DOMParser) v = new DOMParser, r = Zi(r), r = v.parseFromString(Ng(r), "application/xml");
                            else if (qx) {
    ...
    var Ay = ["A9AxgGSwmnfgzzkyJHILUr3H8nJ/3D+57oAsL4DBt4USlng4jZ0weq+fZtHC/Qwwn6gd4QSa5DzT3OBif+kXVA0AAAB4eyJvcmlnaW4iOiJodHRwczovL2ltYXNkay5nb29nbGVhcGlzLmNvbTo0NDMiLCJmZWF0dXJlIjoiUHJpdmFjeVNhbmRib3hBZHNBUElzIiwiZXhwaXJ5IjoxNjk1MTY3OTk5LCJpc1RoaXJkUGFydHkiOnRydWV9", ""];
    ...
    var Fy = function (a, b, c, d, e) {
            ...
            e = void 0 === e ? null : e;
            try {
                if (b = (void 0 === d ? 0 : d) ? Kw(b, "https") : Kw(b), c = c || bx(b), a.h || null != e) Cy(a, b, c, e);
                else {
                    var f = By() ? e : null;
                    xn() ? Dy(b) : Ey(a, b, c, f)
                }
        ...
        Cy = function (a, b, c, d) {
            ...
            I(G.g(), "faa", "1");
            var e = By();
            fetch(b, Gy(c, "" === d && e)).then(function () {
                I(G.g(), "fas", "1")
            }).catch(function () {
                I(G.g(), "faf", "1");
                a.h = !1;
    ...
    var Jy = {},
        Ky = (Jy[18] = -1, Jy[22] = -1, Jy[43] = 350, Jy[44] = 350, Jy[45] = 350, Jy[59] = -1, Jy[133] = 350, Jy[134] = 350, Jy[135] = 350, Jy[136] = 350, Jy[139] = 50, Jy[140] = 50, Jy[141] = 50, Jy[160] = 350, Jy[242] = 150, Jy[243] = 150, Jy[244] = 150, Jy[245] = 150, Jy[247] = 150, Jy[249] = 50, Jy[250] = 50, Jy[251] = 50, Jy[278] = 150, Jy[342] = -1, Jy[343] = -1, Jy[344] = -1, Jy[345] = -1, Jy[346] = -1, Jy[347] = -1, Jy[396] = -1, Jy[398] = -1, Jy),
        Ly = {},
        My = (Ly[18] = !1, Ly[22] = !1, Ly[43] = !0, Ly[44] = !0, Ly[45] = !0, Ly[59] = !1, Ly[133] = !0, Ly[134] = !0, Ly[135] = !0, Ly[136] = !0, Ly[139] = !0, Ly[140] = !0,
            Ly[141] = !0, Ly[160] = !0, Ly[242] = !0, Ly[243] = !0, Ly[244] = !0, Ly[245] = !0, Ly[247] = !0, Ly[249] = !0, Ly[250] = !0, Ly[251] = !0, Ly[278] = !0, Ly[342] = !1, Ly[343] = !1, Ly[344] = !1, Ly[345] = !1, Ly[346] = !1, Ly[347] = !1, Ly[396] = !0, Ly[398] = !0, Ly),
        Ny = {},
        Oy = (Ny[18] = "video/mp4", Ny[22] = "video/mp4", Ny[43] = "video/webm", Ny[44] = "video/webm", Ny[45] = "video/webm", Ny[59] = "video/mp4", Ny[133] = "video/mp4", Ny[134] = "video/mp4", Ny[135] = "video/mp4", Ny[136] = "video/mp4", Ny[139] = "audio/mp4", Ny[140] = "audio/mp4", Ny[141] = "audio/mp4", Ny[160] = "video/mp4", Ny[242] =
            "video/webm", Ny[243] = "video/webm", Ny[244] = "video/webm", Ny[245] = "video/webm", Ny[247] = "video/webm", Ny[249] = "audio/webm", Ny[250] = "audio/webm", Ny[251] = "audio/webm", Ny[278] = "video/webm", Ny[342] = "video/mp4", Ny[343] = "video/mp4", Ny[344] = "video/mp4", Ny[345] = "video/mp4", Ny[346] = "video/mp4", Ny[347] = "video/mp4", Ny[396] = "video/mp4", Ny[398] = "video/mp4", Ny),
        Py = {},
        Qy = (Py[18] = "avc1.42001E, mp4a.40.2", Py[22] = "avc1.64001F, mp4a.40.2", Py[43] = "vp8, vorbis", Py[44] = "vp8, vorbis", Py[45] = "vp8, vorbis", Py[59] = "avc1.4D001F, mp4a.40.2",
            ...
            "av01.0.05M.08", Py[398] = "av01.0.05M.08", Py);
    ...
    function Ty(a) {
        var b = Oy[a];
        a = Qy[a];
        b ? (b = Sg(b).toLowerCase(), b = a ? b + '; codecs="' + Sg(a) + '"' : b) : b = "";
        return b
    }
    ...
    Vy.prototype.G = function (a) {
        1 === this.state ? (this.g += a, this.state = 2) : 0 === this.state && (this.g += a, this.state = 1, Wy(this))
    };
    var Wy = function (a) {
            Ha(function (b) {
        ...
        Yy = function (a) {
            ...
            return Ha(function (c) {
                switch (c.g) {
                    ...
                    case 2:
                        if (b = c.h) return b.va && (a.state = 3), $y(a, b.video), c.return();
                        c.j = 3;
                        return xa(c, Zy(a), 5);
                    case 5:
                        ya(c);
        ...
        Zy = function (a) {
            ...
            return Ha(function (k) {
                if (1 == k.g) return b = 0,
                    c = a.g - a.j, xa(k, fetch(a.uri.toString()), 2);
                d = k.h;
                if (400 <= d.status) return I(G.g(), "lvlfes", d.status.toString()), a.l = d.status, k.return(Promise.reject());
    ...
    function hz() {
        ...
        if (Ib()) {
            if (void 0 === Fw) {
                ...
                a || (void 0 === Ew && (Ew = pb(Gw(), "afma-sdk-a") ? !0 : !1), a = Ew);Fw = a
            }
            return Fw ? !0 : oh() ? !1 : iz()
        }
        a = Kb() ||
            (Hb() ? "Linux" === wb.platform : z("Linux")) || (Hb() ? "Windows" === wb.platform : z("Windows")) || (Hb() ? "Chrome OS" === wb.platform : z("CrOS"));
    ...
    var nz = {
        ...
        zz = function (a, b) {
            return "error" in a ? new mz(a.error, b) : new mz({
                name: "UnknownError"
            }, b)
        },
        Az = function (a, b) {
            return "name" in a ? new mz(a, b + ": " + a.message) : new mz({
                name: "UnknownError"
            }, b)
        };
    var Bz = function (a) {
    ...
    */
    ...
    Ez.prototype.then = function (a, b, c) {
        var d, e, f = new gt(function (g, h) {
            e = g;
            d = h
        });
        Lz(this, e, function (g) {
        ...
        Iz = function (a) {
            ...
            for (var d = c = !1; a.l.length && !a.B;) {
                ...
                if (f = a.o ? g : f) try {
                    ...
                    if (et(b) || "function" === typeof w.Promise && b instanceof w.Promise) d = !0, a.B = !0
                } catch (k) {
                    b = k, a.o = !0, Nz(a) ||
                        (c = !0)
                }
            ...
            a.h = b;
            d && (h = Za(a.D, a, !0), d = Za(a.D, a, !1), b instanceof Ez ? (Lz(b, h, d), b.H = !0) : b.then(h, d));
    ...
    var Wz = function (a, b, c, d, e) {
            ...
            try {
                ...
                return c += zh(d), e && (c += ", with key " + zh(e)), Fz(f, Az(h, c)), f
            }
    ...
    Vz.prototype.add = function (a, b) {
        return Wz(this, "add", "adding into " + this.getName() + " with value ", a, b)
    };
    Vz.prototype.remove = function (a) {
        ...
        try {
            ...
            return c = "removing from " + this.getName() + " with key " + zh(a), Fz(b, Az(e, c)), b
        }
    ...
    Vz.prototype.get = function (a) {
        ...
        try {
            ...
            return c = "getting from " + this.getName() + " with key " + zh(a), Fz(b, Az(e, c)), b
        }
    ...
    l = Zz.prototype;
    l.Re = function (a) {
        a.target instanceof mz ? this.dispatchEvent({
            type: "error",
            target: a.target
        }) : this.dispatchEvent({
            type: "error",
    ...
    var cA = function (a) {
        var b = new Ez;
        void 0 == jz && (jz = w.indexedDB || w.mozIndexedDB || w.webkitIndexedDB || w.moz_indexedDB);
        ...
        c.onerror = function (d) {
            Fz(b, zz(d.target, "opening database IndexedDbVideoChunkPersistentStorage"))
        };
        c.onupgradeneeded = function (d) {
            if (a) {
                var e = new $z(d.target.result);
                a(new aA(d.oldVersion, d.newVersion), e, new Zz(d.target.transaction, e))
            }
        };
    ...
    dA.prototype.initialize = function () {
        var a = this;
        return Promise.resolve(cA(this.h)).then(function (b) {
            a.g = b
        }, function (b) {
    ...
    var eA = function (a, b) {
        ...
        iA = function (a) {
            for (var b = [a.tg, a.source, a.Kd].join(), c = 0, d = 0; d < b.length; d++) c = Math.imul(31, c) + b.charCodeAt(d) | 0;
        ...
        hA = function (a, b, c) {
            ...
            return Promise.resolve(d.get(b)).then(function (e) {
                    ...
                    if (e.Cc !== c) return I(G.g(), "cdl", "1"), d.remove(b).then(null, function (f) {
        ...
        jA = function (a, b) {
            ...
            Promise.resolve(Xz(a, b)).then(function () {
                I(G.g(), "cavs", "1")
            }, function (c) {
    ...
    kA.prototype.G = function (a) {
        1 === this.state ? (this.g += a, this.state = 2) : 0 === this.state && (this.g += a, this.state = 1, lA(this))
    };
    var lA = function (a) {
            Ha(function (b) {
        ...
        oA = function (a) {
            return new Promise(function (b, c) {
                ...
                d.addEventListener("load", function () {
                    J("lvlcl");
                    if (400 <= d.status) return I(G.g(), "lvlxes", d.status.toString()), a.l = d.status, c();
                    var g = d.response;
    ...
    function sA(a) {
        return [43, 44, 45].includes(a) && Ic ? !1 : My[a] ? (a = Ty(a), !!a && rA() && MediaSource.isTypeSupported(a)) : !1
    };
    var tA = function () {};
    ...
    var zA = function (a) {
        ...
        yA = function (a) {
            ...
            for (var b = {
                ...
                K(cl) ? (b.Bd = new vA(a.h.addSourceBuffer(c.mimeType), b.xa), b.Dc = a.l[b.xa], b.Dc.O("progress", function (d) {
                    return function (e) {
                        var f = d.Bd,
                            g = d.Dc;
                        e = e.cd;
                        0 !== e.byteLength && (f.h.push(e), uA(f));
                        g.B() && (a.B++, a.B === a.g.length &&
                            BA(a))
                    }
                }(b)), b.Dc.O("media_source_error", function (d) {
                    a.dispatchEvent(d)
                }), a.g.push(b.Bd.g)) : (b.kb = a.h.addSourceBuffer(c.mimeType), b.kb ? (b.Ec = a.l[b.xa], K(bl) && b.kb.addEventListener("updateend", function (d) {
                    return function () {
                ...
                }(b)), b.kb.addEventListener("error", function (d) {
                    return function () {
                        J("msms_sbe" + d.xa)
                    }
                }(b)), b.Ec.O("progress", function (d) {
                    return function (e) {
                        var f = d.kb,
                            g = d.Ec;
                        e = e.cd;
                        0 !== e.byteLength && (K(bl) ? f.updating ? a.D.push(e) :
                            f.appendBuffer(e) : f.appendBuffer(e));
        ...
        CA = function (a) {
            if (a.J)
                for (var b = 0; b < a.j.length; ++b) {
                    var c = a.l[b],
                        d = a.g[b];
                    d = 0 === d.buffered.length ?
                        0 : 1E3 * d.buffered.end(0);
    ...
    var EA = RegExp("/pagead/conversion|/pagead/adview|/pagead/gen_204|/activeview?|csi.gstatic.com/csi|google.com/pagead/xsul|google.com/ads/measurement/l|googleads.g.doubleclick.net/pagead/ide_cookie|googleads.g.doubleclick.net/xbbe/pixel"),
        FA = RegExp("outstream.min.js"),
        GA = RegExp("outstream.min.css"),
        HA = RegExp("fonts.gstatic.com"),
        IA = RegExp("googlevideo.com/videoplayback|c.2mdn.net/videoplayback|gcdn.2mdn.net/videoplayback"),
    ...
    function KA(a, b) {
        var c = 0,
            ...
            m = !1,
            n = !1;
        if ("function" === typeof Ma("performance.getEntriesByType", w) && "transferSize" in w.PerformanceResourceTiming.prototype) {
            var q = w.performance.getEntriesByType("resource");
            q = t(q);
            for (var r = q.next(); !r.done; r = q.next()) r = r.value, EA.test(r.name) || (f += 1, r.transferSize ? (c += r.transferSize, r.encodedBodySize && r.transferSize < r.encodedBodySize && (h += 1, e += r.encodedBodySize, FA.test(r.name) && (m = !0), GA.test(r.name) && (n = !0)), IA.test(r.name) && (d += r.transferSize)) :
                0 === r.transferSize && 0 === r.encodedBodySize ? JA.test(r.name) ? c += 6686 : HA.test(r.name) || (k += 1, kj(G.g(), {
                    event_name: "unmeasurable_asset",
                    resource_name: r.name,
                    encoded_body_size: r.encodedBodySize,
                    transfer_size: r.transferSize
                })) : (g += 1, e += r.encodedBodySize, FA.test(r.name) && (m = !0), GA.test(r.name) && (n = !0)));
            q = 0;
            if (a.duration) {
                for (r = 0; r < a.buffered.length; r++) q += a.buffered.end(r) - a.buffered.start(r);
    ...
    QA.prototype.l = function (a) {
        ...
        if (b) {
            var c = this.h[b];
            0 != this.o ? (this.j.push(a), this.g[a + 1] = function () {}) : (c && Wb(c, a), delete this.g[a], delete this.g[a + 1], delete this.g[a + 2])
        }
        return !!b
    };
    ...
    var WA = function (a, b, c) {
        a.ub && (RA(a.ub.g, b, c), co(a, function () {
            SA(a.ub.g, b, c)
        }))
    };
    var XA = function (a, b) {
    ...
    var cB = "autoplay controls crossorigin demuxedaudiosrc demuxedvideosrc loop muted playsinline poster preload src webkit-playsinline x-webkit-airplay".split(" "),
        ...
        fB = !RegExp("^\\s*class\\s*\\{\\s*\\}\\s*$").test(function () {}.toString()),
        gB = HTMLElement;
    fB && (gB = function () {
        var a = Object.getPrototypeOf(this).constructor;
        return w.Reflect.construct(HTMLElement, [], a)
    }, Object.setPrototypeOf(gB, HTMLElement), Object.setPrototypeOf(gB.prototype, HTMLElement.prototype));
    var hB = function (a) {
            if (null !== a) {
                a = t(a);
                for (var b = a.next(); !b.done; b = a.next())
        ...
        jB = function (a) {
            iB.call(this, MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED, void 0 === a ? "" : a)
        };
    u(jB, iB);
    var nB = function (a, b) {
        b = void 0 === b ? !1 : b;
    ...
    var qB = function (a, b, c) {
        ...
        rB = function (a) {
            a.qa && (a.T.removeEventListener("timeupdate", a.Sb), a.qa.W(), a.qa = null)
        },
        sB = function (a, b) {
            a.Zd = b;
            ...
            if (w.MutationObserver) {
                var b = new MutationObserver(function (c) {
                    ...
                    for (var d = c.next(); !d.done; d = c.next())
                        if (d = d.value, "childList" === d.type && (d = hB(d.addedNodes))) {
                            wB(a, d);
                            b.disconnect();
                            break
                        }
        ...
        oB = function (a, b) {
            if (b !== a.te) {
                ...
                var c = b ? Sy(b) : null,
                    d = !!c && sA(c);
                I(G.g(), "umsem", d ? "1" : "0");
                d ? (b = Mv(LA, b, Ty(c), 1E3 * Ky[c], null), a.qa = Mv(AA, [b]), a.Ib && a.qa.Tc(a.Ib), a.qa.O("media_source_error", function (e) {
                    ...
                    e.F =
                        1E3 * a.T.currentTime;
                    CA(e)
                }, a.T.addEventListener("timeupdate", a.Sb), qB(a, "src", DA(a.qa))) : (rB(a), qB(a, "src", b));
                a.ye || a.T.load()
            }
        },
        pB = function (a) {
            a.src && sB(a, new iB(MediaError.MEDIA_ERR_ABORTED, "Setting demuxed src after src is already set."));
        ...
        tB = function (a) {
            for (var b = t(dB), c = b.next(), d = {}; !c.done; d = {
                    Va: void 0,
                    getValue: void 0
                }, c = b.next()) d.Va =
                c.value, d.Va in a.T && ("function" === typeof a.T[d.Va] ? (d.getValue = a.T[d.Va].bind(a.T), Object.defineProperty(a, d.Va, {
                    set: function (e) {
                        return function (f) {
                            a.T[e.Va] = f
                        }
    ...
    nB.prototype.disconnectedCallback = function () {
        ...
        gB.prototype.disconnectedCallback && gB.prototype.disconnectedCallback.call(this)
    };
    ...
    w.customElements && (w.customElements.get("lima-video") || w.customElements.define("lima-video", nB));
    ...
    var BB = function (a, b) {
        ...
        zB = function (a) {
            ...
            a.h.addEventListener("updateend", function () {
                a.h.buffered.length && (a.ac = a.h.buffered.end(0), a.A ? a.va && !a.h.updating && a.j === a.D && (J("sl_lc" + a.o), a.ma()) : a.H && !a.h.updating && a.j === a.D && (J("sl_lc" + a.o), a.ma()));
            ...
            a.A ? (a.l.Qa() ? FB(a) : a.Ma = Hs(a.l, "initialized", function () {
                FB(a)
        ...
        DB = function (a) {
            if (400 <= a.g.status) CB(a, 'Response code "' + a.g.status + '" on loading chunk ' + a.j + " for stream " + a.o);
            else {
                if (!a.V) {
                    var b = a.g.getResponseHeader("content-type");
                    if (b && 0 <= b.indexOf("text/plain")) {
                        a.g.readyState === XMLHttpRequest.DONE && (a.J = new R(a.g.response), a.j = 0, a.D = 0, a.Wa++, FB(a));
                        return
                    }
                    a.V = !0;
                    J("sl_redc" + a.o);
                ...
                a.J.g.remove("alr");
                if (a.g.readyState === XMLHttpRequest.LOADING || a.g.readyState === XMLHttpRequest.DONE) b = IB(a, a.U), a.U = a.g.response.length, a.Z += b.byteLength, JB(a, b);
                if (a.A && a.g.readyState === XMLHttpRequest.DONE && (b = IB(a, 0), 0 < b.byteLength)) {
        ...
        EB = function (a) {
            var b = Pw; - 1 !== b && b < a.Z + a.Ga ? (a.F.pause(), Pw = -1, b = !1) : (b = a.D === a.j && !a.h.updating && !a.B.length, b = a.A ? !a.va && b && a.F.currentTime >= a.X : !a.H && b && a.F.currentTime >= a.X);
            b && (a.X = a.ac + .1, FB(a))
        },
        GB = function (a) {
            var b = a.A && a.G ? a.G + 1 : a.j * a.Ga;
            return xw(a.J, "range", b + "-" + (b +
                a.Ga - 1)).toString()
        },
        FB = function (a) {
            if (a.A) {
                ...
                a.l.Nb(b).then(function (c) {
                    c ? (a.G = Number(c.tc), a.va = c.va, JB(a, c.video), c = Uy("get_video_succeeded"), a.l.dispatchEvent(c), a.D++) : HB(a);
                    a.j++
                })
            } else HB(a), a.j++
        };
    ...
    var MB = function (a) {
        ...
        KB = function (a) {
            ...
            for (var b = 0; b < a.F.length; b++) {
                ...
                d ? (a.D.push(d), c = Mv(AB, a.l, c, d, function () {
                    a: if (!a.A) {
                        for (var e = t(a.j), f = e.next(); !f.done; f = e.next())
                            if (f = f.value, f.A ? !f.va || f.h.updating ||
                                f.B.length : !f.H || f.h.updating || f.B.length) break a;
                        a.g.endOfStream();
                        a.A = !0;
                        MB(a)
                    }
                }, b), a.j.push(c)) : J("msmsw_sbf" + b)
            }
    ...
    */
    var NB = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
        OB = function () {
            for (var a = Array(36), b = 0, c, d = 0; 36 > d; d++) 8 == d || 13 == d || 18 == d || 23 == d ? a[d] = "-" : 14 == d ? a[d] = "4" : (2 >= b && (b = 33554432 + 16777216 * Math.random() | 0), c = b & 15, b >>= 4, a[d] = NB[19 == d ? c & 3 | 8 : c]);
            return a.join("")
        };
    var QB = function (a) {
        R.call(this, a);
    ...
    var PB = function (a, b) {
            nb(Sg(b)) || b.split(";").forEach(function (c) {
                var d = c.indexOf("=");
                if (!(0 >= d)) {
        ...
        UB = function (a) {
            var b = SB(a);
            null == b ? b = [Sg(Date.now())] : nb(Sg("ord")) ||
                a.B.delete("ord");
            var c = [];
    ...
    function VB(a) {
        ...
        a = b.h;
        b = RB(b, b.j);
        return !lb(a, ".g.doubleclick.net") && (lb(a, "doubleclick.net") || lb(a, "pagead2.googlesyndication.com")) && hx("/(ad|pfad)[x|i|j]?/", b)
    }
    ...
    function XB(a) {
        a = new R(a);
        var b = a.j;
        return lb(a.h, "googleads.g.doubleclick.net") && hx("/pagead/(live/)?ads", b)
    }
    ...
    var bC = function (a) {
        ...
        c = a.gdprApplies;
        this.h = "boolean" === typeof c ? c ? "1" : "0" : "number" !== typeof c || 1 !== c && 0 !== c ? "string" !== typeof c || "1" !== c && "0" !== c ? "" : "1" === c ? "1" :
            "0" : 1 === c ? "1" : "0";
        c = a.tcString;
    ...
    var cC = function (a) {
        ...
        eC = function (a) {
            return rg(a.g, "videoElementFakeDuration") && (a = a.g.videoElementFakeDuration, "number" === typeof a) ? a : NaN
        },
        fC = function (a) {
    ...
    var lC = function (a, b) {
        ...
        mC = function (a, b) {
            if (!(XB(a) || VB(a) || YB(a) || WB(a) || ZB(a))) {
                var c = new R(a),
                    d = c.j;
                "pubads.g.doubleclick.net" === c.h && (hx("/ssai/", d) || hx("/ondemand/", d))
            }
        ...
        oC = function (a) {
            ...
            if (!(b =
                ...
                if ("true" === b || "1" === b)
                    if (b = a.h.g, a = nC(a, "gdpr_consent"), a = b && "tcunavailable" !== b ? b : "tcunavailable" === b ? a || b : a || "", "tcunavailable" === a) var d = !1;
                    else {
                        if ((b = zv(a)) && a) {
                            var e = Ve(b, Qu, 1);
                            b = Ve(b, Ku, 2) || new Ku;
                            ...
                            for (var H = x.next(); !H.done; H = x.next()) {
                                ...
                                var la = Me(H, 3, he);
                                la = t(la);
                                for (var V = la.next(); !V.done; V = la.next()) e[S][V.value] = jf(H, 2)
                            }
                            a = {
                                tcString: a,
                                tcfPolicyVersion: c,
                        ...
                        if (a) {
                            var M = void 0 === M ? !1 : M;
                            if (gw(a))
                                if (!1 === a.gdprApplies || "tcunavailable" === a.tcString || void 0 === a.gdprApplies && !M || "string" !== typeof a.tcString || !a.tcString.length) d = !0;
                                else {
                                    d = void 0 === d ? "755" : d;
                                    c: {
                                        if (a.publisher && a.publisher.restrictions && (M = a.publisher.restrictions["1"], void 0 !== M)) {
                                            M = M[void 0 === d ? "755" : d];
                                            break c
                                        }
                                        M = void 0
                                    }
                                    0 === M ? d = !1 : a.purpose && a.vendor ? (M = a.vendor.consents, (d = !(!M || !M[void 0 === d ? "755" :
                                        d])) && a.purposeOneTreatment && "CH" === a.publisherCC ? d = !0 : d && (d = a.purpose.consents, d = !(!d || !d["1"]))) : d = !0
                                }
                            else d = !1
                        } else d = !1
                    }
    ...
    rC.ga = [10, 6];
    var BC = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function FC(a) {
        var b;
        return yC(xC(vC(sC(zC(uC(AC(wC(tC(new rC, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), (null == (b = a.fullVersionList) ? void 0 : b.map(function (c) {
            var d = new qC;
            d = mf(d, 1, c.brand);
    ...
    function GC() {
        var a, b;
        return null != (b = null == (a = EC()) ? void 0 : a.then(function (c) {
            return FC(c)
        })) ? b : null
    };
    var IC = function () {
    ...
    var LC = function (a) {
            ...
            return (sc || uc) && !a || rc && (!rc || !Tw(Sw, 4)) || KC() ? !0 : !1
        },
        MC = function (a) {
            return null === a ? !1 : iC.h ? !0 : vc || Uw() ? Ww(a) ? Uw() || Vw(10) && iC.getDisableCustomPlaybackForIOS10Plus() ? !1 : !0 : !0 : rc && (!rc || !Tw(Sw, 4)) || KC() ? !0 : !1
        },
        NC = function () {
            var a = hC(iC);
    ...
    function RC() {
        ...
        return null != window.context ? (a = Number(window.context.ampcontextVersion), isNaN(a) ? !1 : 0 < Math.floor(a)) : null != ai().j
    }
    ...
    X.prototype.report = function (a, b, c) {
        ...
        if (null == w.G_testRunner && (this.j || (void 0 === c ? 0 : c))) {
            ...
            kg(b, function (e, f) {
                null != e && xw(d, f, null == e ? "" : "boolean" === typeof e ? e ? "t" : "f" : "" + e)
            }, this);
            b = TC().o;
    ...
    function ZC(a) {
        ...
        c = "https://pubads.g.doubleclick.net/adsid/integrator.json?aos=" + encodeURIComponent(SC());
        return (new Px).get({
            url: c,
            withCredentials: !0,
            timeout: new kx,
    ...
    bD.prototype.getId = function () {
        ...
        return Ha(function (b) {
            if (1 == b.g) return null != a.g && a.g !== aD ? (b.g = 2, b = void 0) : b = xa(b, a.j, 3), b;
            2 != b.g && (a.g = b.h);
            return b.return(a.g)
        })
    };
    ...
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$companion_ad_selection_settings.CompanionAdSelectionSettings.CreativeType", gD);
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$companion_ad_selection_settings.CompanionAdSelectionSettings.ResourceType", hD);
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$companion_ad_selection_settings.CompanionAdSelectionSettings.SizeCriteria", iD);
    var lD = function (a, b) {
            b = void 0 === b ? new jD : b;
            this.g = a;
            this.settings = b ? b : new jD;
            this.resourceType = kD(hD, this.settings.resourceType) ? this.settings.resourceType : "All";
            this.creativeType = kD(gD, this.settings.creativeType) ? this.settings.creativeType : "All";
            this.sizeCriteria = kD(iD, this.settings.sizeCriteria) ? this.settings.sizeCriteria : "SelectExactMatch";
        ...
        oD = function (a, b) {
            ...
            b.forEach(function (d) {
                a.settings.allowCustom && (!nb(d.getContent()) && (isNaN(d.data.sequenceNumber) || isNaN(d.data.mainAdSequenceNumber) || d.data.mainAdSequenceNumber === d.data.sequenceNumber) && mD(a, d) ? c.push(d) : (d = nD(a, d), null != d && !nb(d.getContent()) && c.push(d)))
            });
            return c
        };
    ...
    var mD = function (a, b) {
            ...
            if (c)
                if (c = b.getSize(), (b = !!b.data.fluidSize) || a.g.ge) a = b && a.g.ge;
                else if ((b = "IgnoreSize" === a.sizeCriteria) || (b = a.g.size, b = b == c ? !0 : b && c ? b.width == c.width && b.height == c.height : !1), b) a = !0;
            else {
                if (b = "SelectNearMatch" === a.sizeCriteria) b =
                    c.width, c = c.height, b = b > a.g.size.width || c > a.g.size.height || b < a.nearMatchPercent / 100 * a.g.size.width || c < a.nearMatchPercent / 100 * a.g.size.height ? !1 : !0;
                a = b
            } else a = !1;
            return a
        },
    ...
    var rD = new qD("Failed to initialize ad playback element before starting ad playback.", 400),
    ...
    CD.prototype.L = function () {
        ...
        this.j.length = 0;
        if (gg(Dv))
            for (var a = t(this.g), b = a.next(); !b.done; b = a.next()) b.value.Na.kc.length = 0;
        this.g.length = 0;
        this.o.length = 0;
        P.prototype.L.call(this)
    };
    ...
    var JD = function (a, b) {
        ...
        ID = function (a) {
            for (var b = t(a.kc), c = b.next(); !c.done; c = b.next()) c = c.value, c(a.Tb);
            a.kc.length = 0
        };
    ...
    KD.prototype.jb = function (a) {
        this.gb || (this.gb = !0, this.Tb = null, this.ud = a, this.Pc.reject(a), gg(Dv) && ID(this))
    };
    var ND = function (a) {
        this.gb = !1;
        this.g = a
    ...
    function RD(a, b, c) {
        ...
        return Ha(function (k) {
            if (1 == k.g) return d = c ? a.filter(function (m) {
                return !m.ec
            }) : a, xa(k, Promise.all(d.map(function (m) {
                return m.Na.promise
            })), 2);
            ...
            if (gg(Ev)) {
                ...
                return xa(k, Promise.all(e.map(function (m) {
                    return m.Na.promise
                })), 0)
            }
            return xa(k, Promise.race([Promise.all(e.map(function (m) {
                return m.Na.promise
            })), new Promise(function (m) {
                return void setTimeout(m,
                    c)
            })]), 0)
        })
    }
    ...
    TD.prototype.start = function () {
        ...
        return Ha(function (c) {
            ...
            !(b instanceof FD) && b instanceof Error && (a.o ? a.o(a.id, b) : a.A(a.id, b), UD(a, b));
            c.g = 0
        })
    };
    var SD = function (a) {
            if (!a.l && a.D) try {
                ...
                if (!c.some(function (k) {
                    ...
                    if (d.length)
                        if (gg(Ev)) {
                            for (var g = t(a.g.o), h = g.next(); !h.done; h = g.next()) h.value.g();
                ...
                !(a.ya() || k instanceof FD) && k instanceof Error && (a.o ? a.o(a.id, k) : a.A(a.id, k), UD(a, k))
            }
        },
        VD = function (a) {
    ...
    function aE(a) {
        ...
        if (a) {
            ...
            for (d = {}; !e.done; d = {
                    zc: void 0
                }, e = c.next()) d.zc = e.value, (e = AD().get(d.zc, a).Db) && !$D(b, d.zc) && (f = BD(e), 2 !== f && 3 !== f && (lf(e, 9, !1), f = bf(e, 2), $e(b, 2, xu, e), e = {}, wD(19, d.zc, null, (e.hs = f ? "1" : "0", e))))
        }
            ...
            Ha(function (v) {
                switch (v.g) {
                    case 1:
                        ...
                        return xa(v, Promise.all(a.g.map(function (x) {
                            return x.h.promise
                        })), 2);
                    case 2:
                        b = t(a.o);
                        for (c = b.next(); !c.done; c = b.next()) d = c.value, gg(Dv) ? (d.D = !0, SD(d)) : d.start();
                        e = t(a.A);
                        ...
                        return xa(v, Promise.all(Object.values(a.j).map(function (x) {
                            return x.promise
                        })), 6);
                    case 6:
                        for (k = v.h, m = 0, n = t(h), q = n.next(); !q.done; q = n.next()) r = q.value, a.l[r] = k[m++];
                    case 4:
    ...
    iE.prototype.h = function () {
        var a = this.H.value,
            b = function (c) {
                var d = {};
                wD(c, bf(a, 1), null, (d.tic = String(Math.round((Date.now() - af(a, 3)) / 6E4)), d))
            };
        switch (BD(a)) {
            case 0:
                b(24);
    ...
    oE.prototype.h = function () {
        ...
        else if ("string" !== typeof c) wD(21, b), b = this.j, a = a.jb(vu(113)), JD(b, a);
        else {
    ...
    sE.prototype.h = function () {
        if (this.j)
            if ("object" !== typeof this.j) wD(46, "UNKNOWN_COLLECTOR_ID"), tE(this, "UNKNOWN_COLLECTOR_ID", 112);
            else {
                var a = this.j.id,
                    b = this.j.networkCode;
                a && b && (delete this.j.id, wD(47, a + ";" + b));
                a = null != b ? b : a;
                "string" !== typeof a ? (b = {}, wD(37, "INVALID_COLLECTOR_ID", null, (b.ii = JSON.stringify(a), b)), tE(this, "INVALID_COLLECTOR_ID", 102)) : "function" !== typeof this.j.collectorFunction ? (wD(14, a), tE(this, a, 105)) : C(fg).g(Cv.g, Cv.defaultValue).includes(a) ? (wD(22, a), tE(this, a, 104)) : JD(this.H, this.j)
            }
        else wD(39,
            "UNKNOWN_COLLECTOR_ID"), tE(this, "UNKNOWN_COLLECTOR_ID", 110)
    };
    ...
    uE.prototype.addOnSignalResolveCallback = function (a) {
        this.A.push(a);
        for (var b = t(this.B), c = b.next(); !c.done; c = b.next()) c.value.then(a)
    };
    ...
    uE.prototype.clearAllCache = function () {
        ...
        } else if (c = String(Ph(null != b ? b : "")), C(fg).g(Bv.g, Bv.defaultValue).includes(c)) c = {}, wD(48, "", null, (c.url = b, c));
        else {
            var d = new cE;
    ...
    function xE(a, b, c, d, e, f) {
        f = void 0 === f ? bE : f;
        Lh() !== Mh() ? wD(16, "") : yE(a, "encryptedSignalProviders", c, e) && yE(a, "secureSignalProviders", c, e) || (wD(38, ""), zE(a, "encryptedSignalProviders", b, f, c, d, e), zE(a, "secureSignalProviders", b, f, c, function () {}, e))
    }
    ...
    function zE(a, b, c, d, e, f, g) {
        var h, k = new uE(null != (h = a[b]) ? h : [], c, "secureSignalProviders" === b, f, d);
        a[b] = new wE(k);
    ...
    function GE(a, b) {
        return (b = EE(b)) && 0 !== a.length ? BE(DE(), a, b, function () {}) : null
    }
        ...
        var e = new ED,
            ...
            g = function (k) {
                try {
                    ...
                    f === m.paw_id && (eg(a, "message", g), m.error ? e.reject(Error(m.error)) : e.resolve(d(m)))
                } catch (n) {}
            },
            h = IE(a);
        return h ? (dg(a, "message", g), f = c(h), e.promise) : (c = JE(a)) ? (f = String(Math.floor(2147483647 * Nh())), dg(a, "message", g), b(c, f), e.promise) : null
    }
    ...
    var NE = function () {
        ...
        PE = function (a) {
            if (LE()) {
                if (K($k) || K(Yk) && rc || K(Wk) && (vc || Uw())) return Promise.resolve("0");
                if (K(al) || OE()) {
                    var b;
        ...
        RE = function (a) {
            ...
            return Ha(function (c) {
                if (1 == c.g) {
                    ...
                    b = Date.now() - a.g;
                    !a.signal || 3E5 < b ? c = xa(c, QE(a), 3) : (c.g = 2, c = void 0);
                    return c
                }
        ...
        QE = function (a) {
            return Promise.race([PE(a).then(function (b) {
    ...
    TE.prototype.B = function (a) {
        ...
        if (VE(this, b)) {
            ...
            VE(this, b) && this.dispatchEvent(new fD(b.name, b.type, b.data || {}, b.sid, a.origin))
        }
    };
    var VE = function (a, b) {
        if (null == b) return !1;
    ...
    var YE = function (a, b) {
        ...
        $E = function (a) {
            null != a.g && a.F && (ZE(a), a.F = !1, a.D = !1, a.A = !1, a.h = 0, a.l = [], a.B = !1)
        },
        XE = function (a) {
            ZE(a);
            !(a.g instanceof Q) && "ontouchstart" in document.documentElement && vc ? (a.G = {
                touchstart: function (b) {
                    a.D = !0;
                    a.h = b.touches.length;
                    a.j && (window.clearTimeout(a.j), a.j = 0, a.J = !0);
                    a.B = aF(a, b.touches) || 1 !== b.touches.length;
                    a.B ? (a.N = Infinity, a.U = Infinity) : (a.N = b.touches[0].clientX, a.U = b.touches[0].clientY);
                    b = b.touches;
                    a.l = [];
                ...
                touchmove: function (b) {
                    a.h = b.touches.length;
                    if (!Vw(8) || Math.pow(b.changedTouches[0].clientX - a.N, 2) + Math.pow(b.changedTouches[0].clientY - a.U, 2) > Math.pow(5, 2)) a.A = !0
                },
                touchend: function (b) {
                    return void bF(a, b)
                }
        ...
        bF = function (a, b) {
            !a.D || 1 !== a.h || a.A || a.J || a.B || !aF(a, b.changedTouches) || (a.j = window.setTimeout(function () {
                    return void cF(a)
                },
                300));
            a.h = b.touches.length;
    ...
    var gF = function () {
            ...
            return a ? xw(new R("https://securepubads.g.doubleclick.net/pagead/ppub_config"), "ippd", a).toString() : null
        },
        iF = new fF;
    var jF = "abort canplay canplaythrough durationchange emptied loadstart loadeddata loadedmetadata progress ratechange seeked seeking stalled suspend waiting".split(" ");
    var kF = function (a, b) {
        P.call(this);
        this.g = a;
        this.timeoutMs = b;
    ...
    var mF = function (a) {
            ...
            a.g.addEventListener(function (e) {
                ...
                else if ("listenerRegistered" === e.eventName) c = e.listenerId, 1 === e.pingData.applicableSections.length && -1 === e.pingData.applicableSections[0] && b.resolve(new lF("", "-1"));
    ...
    var nF = fa(["https://pagead2.googlesyndication.com/omsdk/releases/live/omweb-v1.js"]),
        oF = fa(["https://pagead2.googlesyndication.com/omsdk/releases/control/omweb-v1.js"]),
        pF = fa(["https://pagead2.googlesyndication.com/omsdk/releases/canary/omweb-v1.js"]),
        qF = fa(["https://pagead2.googlesyndication.com/omsdk/releases/experimental/omweb-v1.js"]),
        rF = Ji(nF),
        sF = Ji(oF),
        tF = Ji(pF),
        uF = Ji(qF);
    ...
    function vF(a) {
        return (a = mh(a)) && a.omidSessionInterface ? a.omidSessionInterface : null
    }

    function wF(a) {
        var b, c, d, e, f, g;
        return Ha(function (h) {
            if (1 == h.g) return b = ih("IFRAME", {
    ...
    var zF = function (a) {
            try {
                a.g && a.g.registerSessionObserver(function (b) {
                    "sessionStart" === b.type ? yF(a, a.h) : "sessionFinish" === b.type && zF(a)
                })
            } catch (b) {
    ...
    var TF = function (a, b) {
        ...
        eo(this, this.j);
        var c = this.h.za;
        null != c && (this.g = new OF(a, b, c, "videoDisplay2"), eo(this, this.g))
    };
    u(TF, P);
                ...
                if (f && !b.isSlotAPersistentRoadblock(f)) {
                    ...
                    if (g && (d = ah(f.getSlotId().getDomId()))) {
                        ...
                        if (e.friendlyIframeRendering) try {
                            ...
                            Hh(q, Zi(g));
                            q.close()
                        } catch (r) {} else Fh(d, Zi(g)), d.style.width = h + "px", d.style.height = k + "px";
    ...
    var $F = function (a, b) {
        ...
        aG = function (a, b, c, d) {
            a.g.hasOwnProperty(b) || (c = new TE(b, c), a.h.O(c, a.messageName, function (e) {
                this.dispatchEvent(new YF(e.type, e.messageType, e.ra, e.sessionId, e.origin, b))
            }), c.g = d, c.connect(), a.g[b] = c)
        };
    ZF.prototype.L = function () {
        for (var a = t(Object.values(this.g)), b = a.next(); !b.done; b = a.next()) bo(b.value);
        Q.prototype.L.call(this)
    };
    ZF.prototype.j = function (a) {
        ...
        if (null != b) {
            ...
            if (this.l && !this.g.hasOwnProperty(c)) {
                ...
                this.dispatchEvent(new YF(b.name, b.type, b.data || {}, d, a.origin, c))
            }
        }
    };
    ...
    var dG = function () {
        ...
        bG() || E().top === E() || (this.g = new ZF("gpt", !1), eo(this, this.g), this.O(this.g, "gpt", this.l))
    };
    u(dG, rx);
    dG.prototype.A = function (a) {
        ...
        b = b.match(uh);
        if (c[3] == b[3] && c[4] == b[4])
            if (null != this.g) aG(this.g, a.g, a.sessionId, E().parent), null != this.g && $F(this.g, a);
            ...
            if ("proxy" === b) {
                var e = a.messageType;
                "isGptPresent" === e ? d = bG() : "isConsolePresent" === e && (d = null != cG())
            } else if (bG())
                ...
                if (e = cG(), null != e && (b = e[a.messageType], null != b)) try {
                    b.apply(e, c)
                } catch (g) {}
            } else null === b && (e = a.messageType, "googleGetCompanionAdSlots" === e ? (e = VF()) ? (e = e.getSlots().map(WF), d = e.length ? e : null) : d = null : ("googleSetCompanionAdContents" === e && XF(null == c ? void 0 : c[0]), d = null));
        ...
        fG = {
            s: function (a, b, c) {
                return isNaN(c) || "" == c || a.length >= Number(c) ? a : a = -1 < b.indexOf("-", 0) ?
                    a + Rg(" ", Number(c) - a.length) : Rg(" ", Number(c) - a.length) + a
            },
            f: function (a, b, c, d, e) {
                ...
                return d = 0 <= b.indexOf("-", 0) ? f + d + Rg(" ", a) : f + Rg(0 <= b.indexOf("0", 0) ? "0" : " ", a) + d
            },
            d: function (a, b, c, d, e, f, g, h) {
                return fG.f(parseInt(a,
                    10), b, c, d, 0, f, g, h)
            }
        };
    fG.i = fG.d;
    ...
    var jG = function (a, b) {
        ...
        null != d ? c = d : (d = new dG, y("google.ima.gptProxyInstance", d, c), c = d);
        this.V = c;
        this.B = null;
        this.j = new rx(this);
        eo(this, this.j);
        c = this.F;
        d = (Rh() ? "https:" : "http:") + gG("//imasdk.googleapis.com/js/core/bridge3.612.0_%s.html", iC.getLocale());
        a: {
            var e = window;
            try {
                do {
    ...
    var iG = function (a, b) {
        b = void 0 === b ? "*" : b;
        var c = a.A.get(b);
        null == c && (c = new TE(a.F, b), a.G && (c.g = mh(a.g), c.connect()), a.A.set(b, c));
        return c
    };
    jG.prototype.cc = function (a) {
        var b;
        null != (b = this.B) && (a = a.N.g, b.A = a, b.g && (b = b.g, b.h = a, yF(b, a)))
    };
    ...
    jG.prototype.Z = function (a) {
        ...
        if ("TouchEvent" in window && 0 < TouchEvent.length) b = {
            ...
            d.initTouchEvent(a.messageType, !0, !0, window, b.detail, b.screenX, b.screenY,
                b.clientX + c.x, b.clientY + c.y, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, kG(this, b.touches), kG(this, b.targetTouches), kG(this, b.changedTouches), b.scale, b.rotation);
            this.g.dispatchEvent(d)
        }
    };
    jG.prototype.U = function (a) {
        switch (a.messageType) {
            case "showVideo":
                null == this.h ? (this.h = new WE, this.j.O(this.h, "click", this.ba)) : $E(this.h);
                YE(this.h, this.D.Lb());
                break;
            case "hide":
                null !== this.h && (this.h.W(), this.h = null)
    ...
    nG.prototype.init = function (a) {
        if (!this.ua) {
            if (this.g = a || null) this.A.O(this.g, "activityMonitor", this.D), pG(this);
    ...
    var rG = function (a) {
            if (null == a) return !1;
            if ((sc || uc) && null !== a.webkitDisplayingFullscreen) return a.webkitDisplayingFullscreen;
            a = qG(a);
        ...
        qG = function (a) {
            ...
            try {
                "function" === typeof a.getBoundingClientRect && lh(Zg(a), a) && (b = a.getBoundingClientRect())
            } catch (c) {}
            return b
        },
        sG = function (a, b, c, d, e) {
            ...
            if (a.ua) {
                ...
                if (a = d ? a.j.get(d) : iC.j) null == e.opt_fullscreen && (e.opt_fullscreen = rG(a)), null == e.opt_adElement && (e.opt_adElement = a);
    ...
    nG.prototype.D = function (a) {
        ...
        switch (a.messageType) {
            ...
            case "reportVastEvent":
                ...
                break;
            case "fetchAdTagUrl":
                c = {}, c.eventId = b.eventId, a = b.osdId, rg(b, "isFullscreen") && (e = b.isFullscreen), rg(b, "loggingId") && (b = b.loggingId,
                    c.loggingId = b, X.g().report(43, {
                        step: "beforeLookup",
                        logid: b,
                        time: Date.now()
                    })), c.engagementString = wG(this, a, e), this.g && eD(this.g, "activityMonitor", "engagement", c)
        }
    };
    var wG = function (a, b, c) {
        var d, e = b ? null != (d = a.j.get(b)) ? d : null : iC.j;
        a = {};
    ...
    var xG = function (a) {
        ...
        yG = function (a, b) {
            ...
            a.o ? c ? (a.g.currentTime = a.h, AG(a), b()) : setTimeout(function () {
                return void yG(a, b)
            }, 100) : (AG(a), b())
        },
        AG = function (a) {
    ...
    l.load = function (a, b) {
        ...
        if (b)
            ...
            if (c && d && e && f && g && h && (J("hvd_addu"), b.Ca)) {
                ...
                b = e + '; codecs="' + g + '"';
                f = f + '; codecs="' + h + '"';
                if (rA() && rA() && MediaSource.isTypeSupported(b) && rA() && MediaSource.isTypeSupported(f)) {
                    J("hvd_ymse");
                    J("hvd_mse");
                    a = !1;
                    try {
                    ...
                    w.customElements ? a ? a = !0 : (K(Rk) && X.g().report(153, {
                        limvid: "vd"
                    }), a = K(Rk) || K(Lk) || K(Pk) || K(Ok) || K(Mk) || K(Nk) || K(Jk) || K(Kk) ? !0 : !1) : a = !1;
                    a && this.g instanceof nB ? (this.g.Za = c, this.g.ob = d) : (this.aa = new LB(this.g, [new LA(c, b, 35E4, new fz), new LA(d, f, 82E3, new fz)]), eo(this, this.aa), a = this.g, c = this.aa, c.h || (c.h = Dh(c.g).toString()), c = c.h, a.src = c);
                    this.g.load();
                    return
                }
                J("hvd_nmse")
    ...
    var EG = function (a) {
        if (!a.D) {
            ...
            b = void 0 === b ? !1 : b;
            (!Uw() && !Vw(10) || !b && (IC.g(), !1) ? (IC.g(), qb(vb(), "Xbox")) || (sc || uc ? 0 : (!rc || rc && Tw(Sw, 4)) && (xn() ? (IC.g(), !1) : !KC())) : 1) || !rc || rc &&
                Tw(Sw, 3) || (sc || uc) && !Vw(4) || DG(a)
        }
    };
    l = CG.prototype;
    l.Wf = function () {
    ...
    l.re = function (a) {
        null != this.j ? this.J = a : (this.dispatchEvent("play"), vc || Uw() || Jc || EG(this))
    };
    l.Zf = function (a) {
        if (!this.D && (vc || Uw() || Jc)) {
    ...
    var FG = function (a) {
        a.g instanceof HTMLElement && (a.V = gx(a.g, BG), a.V.then(function (b) {
    ...
    CG.prototype.Fa = function () {
        var a = this.getSize(),
            b = rG(this.g);
        if (a.width !== this.size.width || a.height !== this.size.height) !this.fullscreen && b ? DG(this) : this.fullscreen && !b && this.ba(), this.size = a, this.fullscreen = b
    };
    CG.prototype.Ea = function () {
        if (!this.g.ended && this.g.paused && (vc || Kc ? this.g.currentTime < this.g.duration : 1)) {
    ...
    var MG = function (a) {
            ...
            if ("function" == typeof a.next) return new JG(function () {
                return a
            });
            if ("function" == typeof a[Symbol.iterator]) return new JG(function () {
                return a[Symbol.iterator]()
            });
            if ("function" == typeof a.xb) return new JG(function () {
                return a.xb()
            });
    ...
    l.delete = function (a) {
        return PG(this.h, a) ? (delete this.h[a], --this.size, this.j++, this.g.length > 2 * this.size && OG(this), !0) : !1
    };
    var OG = function (a) {
        ...
        if (a.size != a.g.length) {
            var e = {};
            for (c = b = 0; b < a.g.length;) d = a.g[b], PG(e, d) || (a.g[c++] = d, e[d] = 1), b++;
            a.g.length = c
        }
    };
    l = NG.prototype;
    ...
    var WG = function (a, b) {
        ...
        VG = function (a) {
            var b = hC(iC);
            if (dC(b, "useVideoElementFake")) a = SG(), b = ih("DIV", {
                    style: "position:absolute;width:100%;height:100%;top:0px;left:0px;"
                }), Object.assign(b, a), a.g = ih("DIV", {
                ...
                a.g.appendChild(a.h), b.appendChild(a.g), a.l.O(a, ["loadeddata", "playing", "pause", "ended"], a.ag), a = b;
            else {
                b = !1;
                try {
                ...
                if (YG(a, b)) {
                    ...
                    try {
                        ...
                        a = ih("lima-video"), K(Rk) && X.g().report(153, {
                            limvid: "firefail"
                        })
                    }
    ...
    var bH = function (a, b, c) {
        ...
        if (null == a || !lh(Zg(d), d)) throw tD(sD, null, "containerElement", "element");
        this.h = b;
        ...
        this.o = d;
        this.g = null;
        $G(this) && b ? a = new CG(b) : (this.g = new XG(this.o, !0), a = new CG(this.g.h));
        this.da = a;
        this.za = this.j = null;
        if (a = this.g && iC.o) a = !($G(this) || sc || uc || yn() || rc && (!rc || !Tw(Sw, 4)));
        a && (this.j = new XG(this.o, !0), this.za = new CG(this.j.h));
        this.l = c || null;
        this.F = null != this.l;
        $G(this) && b ? "function" !== typeof b.getBoundingClientRect ? (c = this.o, iC.j = c) : c = b : c = this.o;
        this.B = c;
        this.A = new jG(this.o, this);
        this.size = new D(0, 0);
        this.K = "";
        b && (b = yw(b.src || b.currentSrc), 200 > b.toString().length ? this.K = b.toString() : 200 > b.h.length && (this.K = b.h));
        this.Pd = new Map;
        this.Pd.set("videoDisplay1", this.da);
        this.za && this.Pd.set("videoDisplay2",
            this.za);
        aH(this) && !iC.h && console.warn("Custom media element must be a <video> or <audio> element. Viewability/audibility measurement will fail.")
    };
    l = bH.prototype;
    l.initialize = function () {
        this.D = !0;
    ...
    l.cc = function (a) {
        this.da !== a && this.g && this.j && this.za && (a.setVolume(this.da.getVolume()), a = this.da, this.da = this.za, this.za = a, a = this.g, this.g = this.j, this.j = a, this.j.fb(), this.A.cc(this.da))
    };
    l.fb = function () {
    ...
    var $G = function (a) {
        ...
        aH = function (a) {
            var b = ["VIDEO", "AUDIO"],
                c;
            return $G(a) && !!a.h && !b.includes(null == (c = a.h.tagName) ? void 0 : c.toUpperCase())
        };
    ...
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$ad_error.AdError.Type", cH);
    var eH = {
            AD_ERROR: "adError"
        },
        fH = function (a, b) {
    ...
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$ad_error_event.AdErrorEvent.Type", eH);
    var gH = {
    ...
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$ad_event.AdEvent.Type", gH);
    var iH = function (a, b) {
        b = void 0 === b ? null : b;
    ...
    var vH = {
        ...
        xH = function (a) {
            ...
            wH(a).forEach(function (c) {
                var d = mc && c in vH ? c : c.replace(/^-(?:apple|css|epub|khtml|moz|mso?|o|rim|wap|webkit|xv)-(?=[a-z])/i, "");
                0 != d.lastIndexOf("--", 0) && 0 != d.lastIndexOf("var", 0) && (c = uH(sH, a, a.getPropertyValue ? "getPropertyValue" : "getAttribute", [c]) || "", c = pH(c), null != c && uH(tH, b, b.setProperty ? "setProperty" : "setAttribute", [d, c]))
            });
            return new Jg(b.cssText ||
                "", Ig)
        },
        wH = function (a) {
    ...
    zH.prototype.init = function (a) {
        ...
        if (Kc || Ic || kc) {
            ...
            b && nH(b.document, a)
        } else b = this.j, mH ? (a = Zi(a), b.srcdoc = Ng(a)) : (b = b.contentWindow) && nH(b.document, a)
    };
    ...
    zH.prototype.L = function () {
        ...
        if (null != a) {
            var b = this.F;
            a.style.cssText = b instanceof Jg && b.constructor === Jg ? b.g : "type_error:SafeStyle";
            th() || oh() ? (a.src = this.D, a.currentTime = this.G) : (a.removeAttribute("src"), this.h.fb())
        ...
        JH = function (a, b, c) {
            if (c && Uj(b, c, a.g)) {
                ...
                for (e = d.next(); !e.done; e = d.next()) {
                    ...
                    var g = a.g;
                    df(c, 5) && Tj(g) &&
                        (new Rj(g.document)).remove(f, "/", e.value)
                }
            }
        };
    var KH = function () {
    ...
    var OH = function (a, b, c, d) {
            ...
            switch (b) {
                ...
                case "loaded":
                    a.aa =
                        e.getDuration();
                    a.J = !1;
                    NC() && (d = a.G, c = a.Wa, d.h.set(EF(e), a.N), tG(d) && sG(d, "loaded", EF(e), c));
                    b = new hH(b, e, f);
                    break;
                case "start":
                    a.X.set(c.adId, c.companions);
                    null != a.g.Lb() && (null == a.j ? (a.j = new WE, a.U.O(a.j, "click", a.Xf)) : $E(a.j), YE(a.j, a.g.Lb()));
                    b = new hH(b, e);
                    break;
                case "complete":
                    null != a.j && $E(a.j);
        ...
        MH = function (a, b) {
            ...
            a.V ? (a.dispatchEvent(c), NC() && a.h && vG(a.G, a.N, EF(a.h)), a.h = null) : a.F.h.push(c);
            a = {
                error: b.errorCode,
                vis: Wi(document)
            };
        ...
        NH = function (a) {
            var b = a.g.da;
            $G(a.g) && a.l.restoreCustomPlaybackStateOnAdBreakComplete &&
                null != b.Ud && b.Ud()
        },
        LH = function (a, b) {
            var c = a.g.da;
            $G(a.g) && a.l.restoreCustomPlaybackStateOnAdBreakComplete && null != c.Zb ? c.Zb(b) : b && b()
        };
    l = Z.prototype;
    ...
    l.init = function (a, b, c, d) {
        if (this.F.isEmpty()) {
            ...
            null != d && (e.I = ZG(d), LC(e.I) && (e.G = !0, bo(e.g), bo(e.j), bo(e.za), e.g = null, e.j = null, e.za = null, bo(e.da), e.da = new CG(d), "function" !== typeof d.getBoundingClientRect ? (e.B = e.o, iC.j = e.B) : e.B = d, e.A.cc(e.da)));
            this.V = !0;
            this.resize(a,
                b, c);
            d = IF(this.l, this.H);
    ...
    l.start = function () {
        if (this.adTagUrl) {
            ...
            var a = this.g.l,
                b = this.g.o,
                c;
            if (c = a && b && !sn(a)) a = qG(a), b = qG(b), c = 0 < a.width && 0 < a.height && 0 < b.width && 0 < b.height && a.left <= b.left + b.width && b.left <= a.left + a.width && a.top <= b.top + b.height && b.top <= a.top + a.height;
            b = c;
            X.g().report(31, {
                adtagurl: this.adTagUrl,
                customPlayback: $G(this.g),
        ...
        if (null != this.B && 1 === this.getVolume()) {
            var d, e;
            if ("boolean" === typeof (null == (d = this.B) ? void 0 : d.muted) && (null == (e = this.B) ? 0 : e.muted)) this.setVolume(0);
            else {
                var f;
    ...
    function SH(a) {
        if (a instanceof HF) return X.g().report(174, {
            valid: !0
        }), a;
        X.g().report(174, {
            valid: !1
    ...
    y("module$exports$google3$javascript$ads$interactivemedia$sdk$clientside$api$ads_manager_loaded_event.AdsManagerLoadedEvent.Type", TH);
    var VH = function () {
    ...
    var ZH = function (a, b) {
        ...
        this.caller = new Nv(a, "__uspapiLocator", function (d) {
    ...
    function bI(a, b) {
        ...
        return null != (d = null != (c = e) ? c : null == b ? void 0 : b.get(Ph(a))) ? d : 0
    };
    ...
    function eI(a, b, c, d, e) {
        ...
        if (f) {
            var g, h, k, m, n, q = null != (n = null == (g = f(null != (k = b.Jb) ? k : "")) ? void 0 : g.bids) ? n : null == (h = f(null != (m = b.adUnitCode) ? m : "")) ? void 0 : h.bids;
            if (null != q && q.length && (g = q.filter(function (x) {
                    var H = x.adId;
                    return x.auctionId !== c && Object.values(d).some(function (S) {
                        return S.includes(H)
                    })
                }), g.length)) {
                var r, v;
                f = null == (r = e.adUnits) ? void 0 : null == (v = r.find(function (x) {
                    x = x.code;
                    return x === b.Jb || x === b.adUnitCode
                })) ? void 0 : v.mediaTypes;
                r = t(g);
                for (v = r.next(); !v.done; v =
                    r.next()) v = v.value, g = fI(v, d, f), g = lu(a, fu(lf(gu(eu(new du, v.bidder), 1), 6, !0), g)), gI(v.bidder, e, g), "number" === typeof v.timeToRespond && Le(g, 2, je(Math.round(v.timeToRespond)))
            }
        }
    }
    ...
    function hI(a, b, c) {
        null != ee(Je(a, 3)) || (c === b.adUnitCode ? Le(a, 3, de(1)) : c === b.Jb && Le(a, 3, de(2)))
    }
    ...
    function iI(a, b, c, d, e, f, g) {
        ...
        void 0 !== Ue(a, Zt, 5, !1) || (f ? 1 === jf(f, 1) ? mu(a, f) : mu(a, bu($t(au(new Zt, e), 1), bI(c, d))) : mu(a, $t(au(new Zt, e), bI(c, d) ? 2 : 3)))
    }
    ...
    function fI(a, b, c) {
        var d = a.cpm,
            ...
            v = a.width;
        a = new Xt;
        "number" === typeof d && (Le(a, 2, je(Math.round(1E6 * d))), g && g !== f || (d = Math.round(1E6 * Number(e)), isNaN(d) || d === gf(a) || Le(a, 8, je(d))));
        "string" === typeof f && mf(a, 3, f);
        ["string", "number"].includes(typeof h) && (f = new Rt, h = mf(f, 1, String(h)), Ye(a, 6, h));
        if ("object" === typeof k)
        ...
        switch (q || "banner") {
            ...
            case "video":
                ...
                if ("adpod" === (null == c ? void 0 : null == (H = c.video) ? void 0 : H.context)) {
                    var S, la = null == c ? void 0 : null == (S = c.video) ? void 0 :
                        S.adPodDurationSec;
                    Le(b, 1, je(la))
                } else S = null == c ? void 0 : null == (la = c.video) ? void 0 : la.maxduration, Le(b, 1, je(S));
                var V;
                if ("number" === typeof (null == c ? void 0 : null == (V = c.video) ? void 0 : V.skip)) {
                    var M;
        ...
        Number.isFinite(r) && Number.isFinite(v) && (M = new Tt, v = Le(M, 1, ge(Math.round(v))), r = Le(v, 2, ge(Math.round(r))), Ye(a, 7, r));
    ...
    function jI(a, b) {
        ...
        d = new Map;
        a = t(c.entries());
        for (f = a.next(); !f.done; f = a.next()) g = t(f.value), f = g.next().value, h = g.next().value, g = h.requestTime, h = h.eg, g && h && d.set(f, {
            latency: h - g,
            oe: !1
        });
        e = t(e);
        for (a = e.next(); !a.done; a = e.next())
            if (f = a.value, a = f.bidId, f = f.auctionId, a && f === b && (a = d.get(a))) a.oe = !0;
        return d
    }
    ...
    function kI(a, b) {
        ...
        var h = new Map,
            ...
            r, v, x, H = null != (x = dI.get((null != (r = b.Jb) ? r : "") + (null != (v = b.adUnitCode) ? v : ""))) ? x : 0,
            S;
        m = null != (S = m.filter(function (Da) {
            var Va, Sf, od;
            return Number(null == (Va = Da.args) ? void 0 : Va.timestamp) >
                H && (null == (Sf = Da.args) ? void 0 : null == (od = Sf.adUnitCodes) ? void 0 : od.find(q))
        })) ? S : [];
        if (!m.length) return null;
        var la;
        m = null == (la = m.reduce(function (Da, Va) {
        ...
        var M, Md;
        dI.set((null != (M = b.Jb) ? M : "") + (null != (Md = b.adUnitCode) ? Md : ""), m);
        M = pu(n);
        a.version &&
            cI.test(a.version) && mf(M, 6, a.version);
        Ye(M, 9, g);
        g = Zf(function () {
            return jI(k, V)
        });
        ...
        for (S = {}; !m.done; S = {
            ...
            for (x = {}; !Fc.done; x = {
                ...
                if (x.fc && q(Fc)) {
                    hI(M, b, Fc);
                    $a && (null != bf(M, 4) || mf(M, 4, $a), h.has($a) || h.set($a,
                        r));
                    null == he(Je(M, 8)) && Number.isFinite(m) && Le(M, 8, ge(m));
                    var Nd = la.find(function (Da) {
                        return function (Va) {
                    ...
                    iI(M, $a, Fc, d, e, f, gp);
                    Nd ? (gu($a, 1), "number" === typeof Nd.timeToRespond && Number.isFinite(Nd.timeToRespond) && Le($a, 2, je(Math.round(Nd.timeToRespond))), x = fI(Nd, c, nc), fu($a, x)) : (x = g().get(x.fc)) &&
                        !x.oe ? (gu($a, 2), Number.isFinite(x.latency) && Le($a, 2, je(Math.round(x.latency)))) : (x = gu($a, 3), Number.isFinite(m) && Le(x, 2, je(Math.round(m))))
                }
            }
        }
        var ph;
        (null == (ph = a.getConfig) ? 0 : ph.call(a).useBidCache) && eI(M, b, V, c, a);
        return n
    };
    var ME = OE() ? 500 : 2E3,
        lI = function (a) {
            ...
            this.H = new rx(this);
            eo(this, this.H);
            this.U = new cw(window, {
                timeoutMs: 500
            });
            this.V = new ZH(window, {
                timeoutMs: 500
            });
            this.J = new NE;
            OE() && RE(this.J);
            ...
            NC() && (this.j.init(iG(this.l)),
                this.D = uG(this.j, this.g.B), co(this, function () {
                    var d = b.D;
                    b.j.j.delete(d);
    ...
    lI.prototype.requestAds = function (a, b) {
        var c = this,
            d = [],
            e = null;
        ew(this.U) && d.push(new Promise(function (h) {
            hw(c.U, function (k) {
                e = k;
                h()
            })
        ...
        var f = null;
        Ov(this.V.caller) && d.push(new Promise(function (h) {
            $H(c.V, function (k) {
                f = k;
                h()
            })
        ...
        var g = null;
        d.push(mF(this.N).then(function (h) {
            g = h
        }));
    ...
    var mI = function (a, b, c, d) {
        ...
        Promise.all([c, h, d, e]).then(function (n) {
            ...
            q = q.next().value;
            var r = {};
            X.g().report(182, (r.aid = !!iC.A, r.aidf = !!a.A, r.hsc = !m && k, r));
            qI(a, f, b, g, n, q)
        })
    };
    ...
    lI.prototype.X = function (a) {
        ...
        switch (b) {
            case "adsLoaded":
                b = a.ra;
                a = a.sessionId;
                b = new Z(this.j, this.g, b.adTagUrl || "", b.adCuePoints, this.D, b.isCustomClickTrackingAllowed, iG(this.l, a), this.h);
    ...
    var sI = function (a, b) {
            0 !== b.length && (b = GE(b.map(function (c) {
                return {
                    qc: c
                }
        ...
        oI = function (a) {
            var b = aE(EE(a.h));
            b && (a.G.espSignals = b, eD(iG(a.l), "adsLoader", "signalsRefresh", a.G))
        },
        rI = function (a, b) {
            var c = a.F.get(b);
            a.F.delete(b);
        ...
        nI = function (a) {
            var b = a.Ld,
                ...
                e, f, g, h, k, m, n = {};
            var q = void 0 === q ? w : q;
            return n.gfcLoaded = Sh(q.top, "googlefcLoaded"), n.isGdprLoader = a.ne, n.addtlConsent = null != (e = null == b ? void 0 : b.addtlConsent) ?
        ...
        qI = function (a, b, c, d, e, f) {
            ...
            eD(b, "adsLoader", "requestAds",
                d);
            if (K(al) || OE()) a = {}, X.g().report(155, (a.ws = LE(), a.blob = null != e ? e : "undef", a), !0);
            if (f) {
                var g, h;
                e = null != (h = null == (g = Ve(f, qu, 1)) ? void 0 : Me(g, 6, re)) ? h : [];
                var k;
                ...
                c = c ? XB(c) ? "adsense" : WB(c) ? "dbm" : VB(c) ? "dcm" : ZB(c) ? "dv3" : YB(c) ? "xfp" : "thirdparty" : "";
                X.g().report(187, {
                    fm: k,
                    rt: c
                }, !0)
        ...
        uI = function (a) {
            var b;
            return Ha(function (c) {
                if (1 == c.g) return a.A || (a.A = new bD, cD(a.A)), xa(c, a.A.getId(), 2);
                b = c.h;
                iC.A = b.id || "";
                c.g = 0
            })
        ...
        tI = function () {
            return Gb() &&
                (K(pl) || K(ol)) ? K(ol) ? new Promise(function (a) {
                    setTimeout(function () {
                        a()
                    }, 50)
                }) : wI().then(function (a) {
        ...
        vI = function (a, b, c, d) {
            ...
            if (null != x) {
                ...
                for (var Md = [], Fc = 0; V && 25 > Fc; ++Fc) {
                    var nc = void 0,
                        $a = "";
                    void 0 !== M && M || ($a = ($a = 9 !== V.nodeType && V.id) ? "/" + $a : "");
                    a: {
                        if (V && V.nodeName && V.parentElement)
                            for (var gp = V.nodeName.toString().toLowerCase(), Nd = V.parentElement.childNodes, ph = 0, Da = 0; Da < Nd.length; ++Da) {
                                var Va = Nd[Da];
                                if (Va.nodeName && Va.nodeName.toString().toLowerCase() === gp) {
                                    if (V === Va) {
                                        nc = "." + ph;
                                        break a
                                    }++ph
                    ...
                    Md.push((V.nodeName &&
                        V.nodeName.toString().toLowerCase()) + $a + nc);
                    V = V.parentElement
                }
                S = Md.join();
                if (x) {
                    var Sf = x.ownerDocument,
                        ...
                        Qx = [];
                    if (od) try {
                        for (var qh = od.parent, Rx = 0; qh && qh !== od && 25 > Rx; ++Rx) {
            ...
            if (null != m) {
                ...
                for (var Wx = 0; Wx < Iv.length; ++Wx) H.push("");
            var JI = (n.videoAdKey = Ph(H.join(":")).toString(), n);
            var rh = {},
                oc = (rh.consentSettings = c, rh.imalibExperiments = f, rh.settings = k, rh.videoEnvironment = JI, rh),
                Xa = {};
            ...
            if (a.h && iC.isCookiesEnabled()) {
                ...
                if (0 === De.h) {
                    if (pc && Uj("__gads", pc, De.g)) var Xx = !0;
                        ...
                        var Yx =
                            De.g;
                        df(pc, 5) && Tj(Yx) && (new Rj(Yx.document)).set("GoogleAdServingTest", "Good", void 0);
                        var Zx = "Good" === Uj("GoogleAdServingTest", pc, De.g);
                        if (Zx) {
                            var $x = De.g;
                            df(pc, 5) && Tj($x) && (new Rj($x.document)).remove("GoogleAdServingTest", void 0, void 0)
                        }
                        Xx = Zx
                    }
                    De.h = Xx ? 2 : 1
                ...
                null !== cy && (oc.gfpCookieV2OptOut =
                    cy)
            }
            var ip = aE(EE(a.h));
            ip && (a.G.espSignals = ip, oc.espSignals = ip);
            if (K(hl) || K(il) || K(jl) || K(kl)) try {
                var na = new VH,
                    sh = null;
                b.pageUrl ? sh = b.pageUrl : Ow(b.adTagUrl) && (sh = (new URL(b.adTagUrl)).searchParams.get("url"));
                sh && Ow(sh) && (na.url = sh);
                ...
                var OI = ha(Od),
                    Cb = new Map;
                null != na.adWillAutoPlay && Cb.set("vpa", na.adWillAutoPlay ? "auto" : "click");
                null != na.adWillPlayMuted && Cb.set("vpmute", na.adWillPlayMuted ? "1" : "0");
                null != na.continuousPlayback && Cb.set("vconp", na.continuousPlayback ? "2" : "1");
                Cb.set("wta", na.iconsSupported ? "1" : "0");
                Cb.set("pss", na.skippablesSupported ? "1" : "0");
                500 >= na.descriptionUrl.length && Cb.set("video_url_to_fetch", na.descriptionUrl);
                200 >= na.ppid.length && Cb.set("ppid", na.ppid);
                200 >= na.playerType.length &&
                    Cb.set("mpt", na.playerType);
                ...
                Db.u_his = gy;
                var hy;
                Db.u_h = null == (hy = O.screen) ? void 0 :
                    hy.height;
                var iy;
                ...
                0 < lp.length && 0 < mp.length && 200 >= lp.length && 200 >= mp.length && (Pd.set("omid_p", lp + "/" + mp), oy = !0);
                ...
                var WI = QC(),
                    py = bi();
                Pd.set("top", WI);
                na.url ? (Pd.set("url", na.url), Pd.set("loc",
                    py)) : Pd.set("url", py);
                for (var bk = new KI(LI.call(dy, SI, ha(new TI(UI.call(my, VI, ha(Pd)))))), qy = t(bk.keys()), op = qy.next(); !op.done; op = qy.next()) {
                    var ry = op.value;
    ...
    function zI(a, b) {
        var c;
        if (c = void 0 === c ? "undefined" === typeof omidExports ? null : omidExports : c) a = a.split("."), a.slice(0, a.length - 1).reduce(yI, c)[a[a.length - 1]] = b
    };
    var AI = new Map([
    ...
    var BI = function (a, b, c) {
        ...
        CI = function (a, b) {
            return b ? a.g.some(function (c) {
                c = b.match(c);
                return null == c ? !1 : !a.h || 1 <= c.length && "3.612.0" === c[1] || 2 <= c.length && "3.612.0" === c[2] ? !0 : !1
            }) : !1
        },
        DI = [94, 40, 63, 58, 104, 116, 116, 112, 115, 63, 58, 41, 63, 47, 47, 105, 109, 97, 115, 100, 107, 92, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105, 115, 92, 46, 99, 111, 109, 47, 106, 115, 47, 40, 115, 100, 107, 108, 111, 97, 100, 101, 114, 124, 99, 111, 114, 101, 41, 47],
        EI = [94, 40, 63, 58, 104, 116, 116, 112, 115, 63, 58, 41, 63, 47, 47, 115, 48, 92, 46, 50, 109, 100,
            110, 92, 46, 110, 101, 116, 47, 105, 110, 115, 116, 114, 101, 97, 109, 47, 104, 116, 109, 108, 53, 47
        ],
        FI = [94, 40, 63, 58, 104, 116, 116, 112, 115, 63, 58, 41, 63, 47, 47, 105, 109, 97, 115, 100, 107, 92, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105, 115, 92, 46, 99, 111, 109, 47, 112, 97, 108, 47, 115, 100, 107, 108, 111, 97, 100, 101, 114, 47],
        GI = [
    ...
    new BI(EI, HI, !0);
    var ZI = new BI([94, 40, 63, 58, 104, 116, 116, 112, 115, 63, 58, 41, 63, 47, 47, 105, 109, 97, 115, 100, 107, 92, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105, 115, 92, 46, 99, 111, 109, 47, 112, 114, 101, 114, 101, 108, 101, 97, 115, 101, 47, 106, 115, 47, 91, 48, 45, 57, 93, 43, 46, 91, 48, 45, 57, 46, 93, 43, 47], GI, !1),
        $I = new BI([94, 40, 63, 58, 104, 116, 116, 112, 115, 63, 58, 41, 63, 47, 47, 40, 112, 97, 103, 101, 97, 100, 50, 124, 116, 112, 99, 41, 92, 46, 103, 111, 111, 103, 108, 101, 115, 121, 110, 100, 105, 99, 97, 116, 105, 111, 110, 92, 46, 99, 111, 109, 47, 112, 97, 103, 101, 97, 100, 47, 40, 103, 97, 100, 103,
    ...
    if (! function (a) {
            ...
            var b = cJ(a, document.querySelectorAll && document.querySelector ? document.querySelectorAll("SCRIPT") : document.getElementsByTagName("SCRIPT"));
            null == b && document.querySelectorAll && (b = cJ(a, document.querySelectorAll("script")));
            return null != b
        }([XI, ZI, YI, $I, aJ, bJ])) throw Error("IMA SDK is either not loaded from a google domain or is not a supported version.");
    hF(iF);
})();
